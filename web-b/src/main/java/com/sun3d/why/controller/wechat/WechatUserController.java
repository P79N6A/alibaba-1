...
public class WechatUserController {
	...
	public String preCulture(String type, HttpServletRequest request) {
		// 微信权限验证配置
		String url = BindWS.getUrl(request);
		Map<String, String> sign = BindWS.sign(url, cacheService);
		request.setAttribute("sign", sign);
	...
	public String userIntegral(HttpServletRequest request) {
		...
		UserIntegral userIntegral = userIntegralService.selectUserIntegralByUserId(cmsTerminalUser.getUserId());

		request.setAttribute("userId", userIntegral.getUserId());

		request.setAttribute("integralNow", userIntegral.getIntegralNow());
	...
	public String queryUserIntegralDetail(PaginationApp pageApp, Integer pageIndex, Integer pageNum,
	...
	public String queryUserIntegralDetailList(PaginationApp pageApp, Integer pageIndex, Integer pageNum,
			HttpServletResponse response, String userId) throws Exception {
		String json = "";
