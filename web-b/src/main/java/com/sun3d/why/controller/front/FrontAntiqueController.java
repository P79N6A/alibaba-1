 ...
 */
@Controller
@RequestMapping(value = "/frontAntique")
public class FrontAntiqueController {
     ...
     * log4j日志
     */
    private Logger logger = Logger.getLogger(FrontAntiqueController.class);
    ...
    public ModelAndView antiqueList(String typeId,String dynasty,String key,String venueId){
        ...
        model.setViewName("index/antique/antiqueList");
    ...
    public ModelAndView antiqueListLoad(String antiqueName,String venueId,String antiqueYears,Pagination page,String antiqueVenueId){
        ...
        try {
            if(StringUtils.isNotBlank(venueId)){
                ...
                if(StringUtils.isNotBlank(antiqueVenueId)){
                    cmsAntique.setAntiqueTypeId(antiqueVenueId);
                }
        ...
        model.setViewName("index/antique/antiqueListLoad");
        return model;
    }
    ...
    public ModelAndView antiqueDetail(String antiqueId){
        ...
        model.setViewName("index/antique/antiqueDetail");
