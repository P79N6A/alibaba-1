...
public class WechatVenueController {
    ...
    public String wcCmsVenueList(HttpServletResponse response,String venueType, String venueArea, String venueName, String pageIndex, String pageNum, PaginationApp pageApp) throws Exception {
        pageApp.setFirstResult(Integer.valueOf(pageIndex));
        pageApp.setRows(Integer.valueOf(pageNum));
        String json="";
        try {
...
//        request.setAttribute("teamUserList",teamUserList);
    ...
    public String roomBook(HttpServletResponse response,@RequestParam String roomId,@RequestParam String bookId) throws IOException{
    	
    	String json = "";
    	 
    	CmsTerminalUser cmsTerminalUser = (CmsTerminalUser)session.getAttribute(Constant.terminalUser);
    	
    	json = roomBookAppService.queryAppRoomBookByCondition(roomId, bookId, cmsTerminalUser.getUserId());
    ...
    public ModelAndView roomBookOrder(@RequestParam String roomId,@RequestParam String bookId ){
    	
    	 ModelAndView model = new ModelAndView();
    	 
    	 CmsTerminalUser cmsTerminalUser = (CmsTerminalUser)session.getAttribute(Constant.terminalUser);
    	 
    	 model.addObject("userNickName", cmsTerminalUser.getUserNickName());
    	 
    	 model.addObject("userTelephone", cmsTerminalUser.getUserTelephone());
    ...
    @EmojiInspect
    public String roomOrderConfirm(HttpServletResponse response,@RequestParam String bookId,String orderName,String orderTel,String tuserName,String tuserId,String purpose) throws IOException{
         ...
         try {
        	  ...
        	  json= roomBookAppService.appRoomOrderByCondition(bookId, tuserId, tuserName, cmsTerminalUser.getUserId(), orderName, orderTel, purpose);
