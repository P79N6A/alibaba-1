...
public class GetTicketAppController {
    ...
    public String activeOrderTake(HttpServletResponse response, String validateCode,String seats) throws Exception {
        String json = "";
        if (validateCode != null && StringUtils.isNotBlank(seats)) {
            json = activityOrderAppService.takeAppActivityValidateCode(validateCode, seats);
