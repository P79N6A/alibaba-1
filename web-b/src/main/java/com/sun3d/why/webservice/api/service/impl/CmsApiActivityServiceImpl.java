...
//				if(StringUtils.isNotNull(model.getActivityCrowd())){
//					String activityCrowd=this.cmsApiService.getTags(model.getActivityCrowd(), "ACTIVITY_CROWD");
////					if(activityCrowd==null){
////						msg.setStatus(false);
////						msg.setCode(CmsApiStatusConstant.DATA_ERROR);
////						msg.setText(model.getActivityCrowd()+" 该活动的群体在系统中不存在");
////						return msg;
////					}
//					model.setActivityCrowd(activityCrowd);
//				}


//				if(StringUtils.isNotNull(model.getActivityMood())){
//					String activityMood=this.cmsApiService.getTags(model.getActivityMood(), "ACTIVITY_MOOD");
//					if(activityMood==null){
//						msg.setStatus(false);
//						msg.setCode(CmsApiStatusConstant.DATA_ERROR);
//						msg.setText(model.getActivityMood() +"该活动的心情在系统中不存在");
//						return msg;
//					}
//					model.setActivityMood(activityMood);
//				}
	...
	private CmsApiMessage check(CmsApiData<CmsActivity> apiData) throws Exception {
		...
		if(msg.getStatus()){
			...
			/*if(StringUtils.isNull(model.getActivityCrowd())){
				msg.setStatus(false);
				msg.setCode(CmsApiStatusConstant.DATA_ERROR);
				msg.setText("该活动的人群类型不能为空");
				return msg;
			}
			*/
			/*if(StringUtils.isNull(model.getActivityMood())){
				msg.setStatus(false);
				msg.setCode(CmsApiStatusConstant.DATA_ERROR);
				msg.setText("该活动心情类型不能为空");
				return msg;
			}*/
//			if(StringUtils.isNull(model.getActivityLocation())){
//				msg.setStatus(false);
//				msg.setCode(CmsApiStatusConstant.DATA_ERROR);
//				msg.setText("该活动位置类型不能为空");
//				return msg;
//			}
			
		
//			boolean ctbool=this.cmsApiTagsService.checkTags(model.getActivityLocation(), "ACTIVITY_THEME");
//			if(ctbool==false){
//				msg.setStatus(false);
//				msg.setCode(CmsApiStatusConstant.DATA_ERROR);
//				msg.setText("该活动的主题类型不能为不存在");
//				return msg;
//			}
...
//			if(StringUtils.isNull(model.getActivityEndTime())){
//				msg.setStatus(false);
//				msg.setCode(CmsApiStatusConstant.DATA_ERROR);
//				msg.setText("活动结束时间不能为空");
//				return msg;
//			}
...
//			if(!CmsApiUtil.isDate(model.getActivityEndTime())){
//				msg.setStatus(false);
//				msg.setCode(CmsApiStatusConstant.DATA_ERROR);
//				msg.setText("活动结束时间不是日期格式  yyyy-MM-dd hh:mm");
//				return msg;
//			}
...
//			if(model.getActivityReservationCount()==null){
//				msg.setStatus(false);
//				msg.setCode(CmsApiStatusConstant.DATA_ERROR);
//				msg.setText("活动人数不可以为空");
//				return msg;
//			}
...
//				msg.setStatus(false);
//				msg.setCode(CmsApiStatusConstant.ACTIVITY_ERROR);
//				msg.setText(model.getSysId()+" 该活动在系统不存在，无法更新!");
//				return msg;
//			}
