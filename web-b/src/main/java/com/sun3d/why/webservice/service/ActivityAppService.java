...
public interface ActivityAppService {
     ...
     * @return
     */
     public String appActivityOrderByCondition(String activityId, String userId, String activityEventIds, String bookCount, String orderMobileNum, String orderPrice, String activityEventimes, String[] seatIds, String seatValues, String orderName, String orderIdentityCard, String costTotalCredit);
     ...
     * @return
     */
    String queryEventDateActivityCount(String startDate, String endDate) throws Exception;
   ...
   String queryAppCmsActivityListById(String venueId,PaginationApp pageApp);
     ...
     * @return
     */
    String queryAppCmsActivityListByCondition(String activityArea, String activityType, String activityName, PaginationApp pageApp, String lon, String lat);
