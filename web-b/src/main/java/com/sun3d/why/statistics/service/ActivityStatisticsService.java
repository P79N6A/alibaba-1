...
public interface ActivityStatisticsService {
    ...
    List<ActivityData> queryAreaData(ActivityData data);

    List<ActivityData> queryLocationData(ActivityData data);

    List<ActivityData> queryActivityTypeData(ActivityData data);

    List<ActivityData> queryActivityVenueData(ActivityData data);
}