...
public class Constant {
     ...
     * 直播
     */
    public final static Integer TYPE_CULTURE_LIVE = 10;

    /**
     * 新闻评论
     */
    public final static Integer TYPE_NEWS = 11;
    
    public final static Integer TYPE_BPINFO = 20;
    
    public final static Integer TYPE_BPANTIQUE = 21;
    
    public final static Integer TYPE_BPPRODUCT = 22;
    /**
     * 收藏对象类型  场馆-1
     */
    ...
    public final static String LEAGUE_TYPE = "LEAGUE_TYPE";
    ...
    //【文化云】亲爱的${userName}，您已成功预订${activityName]活动的${num}张票，演出时间为${startTime}，请于活动开始前一天至取票地（活动举办点）领取入场门票。
    public static  final String SMS_ACTIVITY_ORDER_CODE4="SMS_157355428";
    //【文化云】您已退订成功！您所报名的"${courseType}"培训"${trainTitle}"已退订。详细报名信息可登陆平台,进入个人中心查看！
    public static  final  String SMS_TRAINING_UNSUBSCRIBE_TRAIN="SMS_157355433";
    //【文化云】您已被录取！您所报名的"${courseType}"培训"${trainTitle}"开课时间为：${trainStartTime},地点为：${trainAddress},请按时参加！详细报名信息可登陆平台,进入个人中心查看！
    public static  final  String SMS_TRAINING_ENTRY_SUCCESS="SMS_151900296";

    public static final String SMS_TRAIN_START_MESSAGE="SMS_158490808";

    //【文化云】亲爱的${name}，您报名的培训“${trainTitle}”因故取消，系统已为您自动取消订单，因此为您带来的不便，请您谅解
    public static  final  String SMS_TRAINING_CANCEL_TRAIN="SMS_157355528";

    public static  final  String SMS_MONTH_ACTIVITY_COUNT_CODE="SMS_32055002";

    public static  final  String SMS_MONTH_ACTIVITY_ZERO_CODE="SMS_32135001";

    public static  final  String SMS_MONTH_ACTIVITY_RESERVATION_COUNT_CODE="SMS_32065003";

    public static  final  String SMS_TERMINALUSER_AUTH_NOT_PASS_CODE="SMS_60210262";

    public static final String SMS_TERMINALUSER_AUTH_PASS_CODE="SMS_60265218";
    ...
    /**********微信服务号 请勿修改*********/
    public static  final String WX_APP_ID="wx847fffbbedaf4065";
    public static  final String WX_APP_SECRET="75a0b1258d7d63b588629853ed3ed4e2";
    /**********微信服务号 请勿修改*********/
