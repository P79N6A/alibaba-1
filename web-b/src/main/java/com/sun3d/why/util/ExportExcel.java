            ...
            for (short i = 0; i < fields.length; i++)
            {
                ...
                if (map.containsKey(fieldName)) {
                    try {
                        ...
                        if("activityIsFree".equals(fieldName)){
                        ...
                        if("orderPaymentStatus".equals(fieldName)){
                            if(value != null && org.apache.commons.lang3.StringUtils.isNotBlank(value.toString())){
                        ...
                        if("orderPayType".equals(fieldName)){
                        	if(value != null && org.apache.commons.lang3.StringUtils.isNotBlank(value.toString())){
                            	if("1".equals(value.toString())){
                                    value = "支付宝";
                                }else if("2".equals(value.toString())){
                        ...
                        if("orderCustomInfo".equals(fieldName)){
                            if(value == null || org.apache.commons.lang3.StringUtils.isBlank(value.toString())){
                                value = "无";
                            }else{                           	                            	                           	     
                            	 ...
                            	 for (int x=0;x<array.size();x++){
                                	 ...
                                	 customInfoHtml += object.get("title")+ ":" +object.get("value");
                                	 if(x != array.size()-1){
                                		 customInfoHtml +="\r\n"; 
                                	 }                               	
                                 }
                            	value = customInfoHtml;
                            }
                          }
