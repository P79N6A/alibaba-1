...
public class UserPublicController {
    ...
    @ResponseBody
    public HttpRes sendCode(String userMobileNo,String userName,String userPwd,Integer userSex) {
    	HttpRes httpRes = new HttpRes();
        ...
        try {
        	Map<String,Object> map = terminalUserService.sendSmsCode(userMobileNo,userName,userPwd,userSex);
