...
public class CmsActivity extends Pagination implements Serializable {
    ...
    private BigDecimal activityPayPrice;// 支付价格
    ...
    private String orderIdentityCard;//身份证
    ...
    //订单开始时间
    private String activityOrderStartTime;
    //订单结束时间
    private String activityOrderEndTime;
    
    public String getActivityOrderStartTime() {
		return activityOrderStartTime;
	}

	public void setActivityOrderStartTime(String activityOrderStartTime) {
		this.activityOrderStartTime = activityOrderStartTime;
	}

	public String getActivityOrderEndTime() {
		return activityOrderEndTime;
	}

	public void setActivityOrderEndTime(String activityOrderEndTime) {
		this.activityOrderEndTime = activityOrderEndTime;
	}
