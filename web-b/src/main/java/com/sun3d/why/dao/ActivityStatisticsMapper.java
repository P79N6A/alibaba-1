...
import com.sun3d.why.model.ActivityData;
import com.sun3d.why.model.ActivityRoutineStatistics;
...
public interface ActivityStatisticsMapper {
    ...
    List<ActivityRoutineStatistics> activityRoutineStatisticsData(Map map);

    List<ActivityData> queryVenueArea(Map map);

    List<ActivityData> queryActivityLocation(Map map);

    ActivityData queryActivityByArea(Map map);

    List<ActivityData> queryActivityType(Map map);

    List<ActivityData> queryActivityVenue(Map map);
}