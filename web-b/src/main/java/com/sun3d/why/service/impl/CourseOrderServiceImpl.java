...
public class CourseOrderServiceImpl implements CourseOrderService{
	...
	@Override
	public List<CourseOrder> queryCourseOrderByCondition(String searchKey, CourseOrder courseOrder,Pagination page, SysUser sysUser) {
		Map<String, Object> map = new HashMap<String, Object>();
		// 权限验证
	...
	@Override
	public List<CourseOrder> queryCourseViewByCondition(String courseId,Pagination page, SysUser sysUser,String searchKey,String status) {
		Map<String, Object> map = new HashMap<String, Object>();
		/*// 权限验证
...
/*      if(StringUtils.isNotBlank(sysUser.getUserId())){
	...
	public String sendMessage(String orderId,final String state) {
		...
		final String content = "恭喜您，您所报的【"+courseOrder.getCourseTitle()+"】课程，已经审核通过，培训时间："+courseOrder.getStartTime()+" 至  "+courseOrder.getEndTime()+" "+courseOrder.getTrainTime()+"，培训地点："+courseOrder.getTrainAddress()+"，请准时参加。";
		Runnable runnable=new Runnable() {
            ...
            public void run() {
            	...
            	try {
					...
					sms.sendSmsMessage(config.getSmsUrl(),config.getuId(),config.getPwd(),mobile,content);
				} catch (Exception e) {
					e.printStackTrace();
				}
            }
	...
	public String sendMessageForAll(String orderId,String allState) {
		...
		if(StringUtils.isNotBlank(courseOrder.getCoursePhoneNum())){
		  content = "友情提醒，您所报的【"+courseOrder.getCourseTitle()+"】课程，培训时间："+courseOrder.getStartTime()+" 至  "+courseOrder.getEndTime()+" "+courseOrder.getTrainTime()+"，培训地点："+courseOrder.getTrainAddress()+"，联系方式："+courseOrder.getCoursePhoneNum()+"，请准时参加。";
		}else{
		  content = "友情提醒，您所报的【"+courseOrder.getCourseTitle()+"】课程，培训时间："+courseOrder.getStartTime()+" 至  "+courseOrder.getEndTime()+" "+courseOrder.getTrainTime()+"，培训地点："+courseOrder.getTrainAddress()+"，请准时参加。";
		}
