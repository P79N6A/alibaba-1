...
public interface CmsTerminalUserService {
     ...
     * @return 会员对象集合
     */
    List<CmsTerminalUser> queryTerminalUserbehaviorAnalysis(CmsTerminalUser user,String curDateStart,String curDateEnd, Pagination page);
    
    /**
     * 查询注册数
     * @return
     */
    List<Integer> queryByRegisterDate(String curDateStart,String curDateEnd);
     ...
     * 发送注册码 验证手机信息
     */
    Map<String,Object> sendSmsCode(String userMobileNo,String userName,String userPwd,Integer userSex) throws ParseException;
