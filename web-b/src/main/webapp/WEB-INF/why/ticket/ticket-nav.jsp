...
<div class="ticket-nav" id="ticket-nav">
    <ul>
        ...
        <% if(session.getAttribute("terminalUser") != null) { %>
                <li class="small" id="ticketUserCenterId"><a href="${path}/ticketUserActivity/ticketUserActivity.do">个人中心</a></li>
          <% } else{ %>
                <li class="small" id="ticketUserCenterId"><a href="${path}/ticketUser/preTicketUserLogin.do">个人中心</a></li>
            <%}%>
        <li class="small" id="ticketMobileId"><a href="${path}/ticketActivity/ticketMobile.do">手机端</a></li>
    </ul>
</div>