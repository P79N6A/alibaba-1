  ...
  <div class="user-login login-dialog">
    ...
    <div class="msg-error" ms-if="errTips!=0">{{errTips}}</div>
      ...
      <div class="user pwd"><label class="txt">密码：</label>
          <input type="password" id="userPwd" class="pwd_input inputs" placeholder="请输入您的密码"    ms-duplex="userPwd"   data-duplex-changed="LoginBtn"   maxlength="12" />
      </div>
