    ...
    <form id="userForm"   ms-controller="dataForm">
      <div class="register-part part1 user" style="position: relative;">
        ...
        <dl>
          <dt>密码</dt>
          <dd class="showPlaceholder">
            <input id="newPass" type="password" class="input-text inputs" value="" name="userPwd"  maxlength="12"
                   ms-duplex="newPass" data-duplex-changed="newPassChange" placeholder="6-12位字母加数字组合" />
        ...
        <dl>
          <dt>确认密码</dt>
          <dd class="showPlaceholder">
            <input id="newPass2" type="password" class="input-text inputs" value="" name="confirmPassword" maxlength="12"
