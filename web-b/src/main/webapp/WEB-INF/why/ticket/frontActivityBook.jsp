...
<head>
  ...
  <script type="text/javascript" src="${path}/STATIC/js/index/ticket/activityOrder.js"></script>
  <link rel="stylesheet" type="text/css" href="${path}/STATIC/css/login_key.css" /><!--模拟键盘-->
  <script type="text/javascript" src="${path}/STATIC/js/activityBook_key.js"></script><!--模拟键盘-->
...
<div id="register-content">
  <div class="register-content">
    ...
    <form action="${path}/userTicket/preSaveActivityOder.do" name="bookForm" id="bookForm" method="post">
        ...
        <table class="tab1" width="100%">
          ...
          <tr>
            <td>
              <div class="input-box showPlaceholder">
                ...
                <input class="input-text phoneNum inputs" name="orderPhoneNo" id="orderPhoneNo"   <c:if test="${not empty orderPhoneNo}"> value="${orderPhoneNo}" </c:if> <c:if test="${empty orderPhoneNo}"> value="${sessionScope.terminalUser.userMobileNo}" </c:if>    type="text" />
              </div>
          ...
          <c:if test="${cmsActivity.activitySalesOnline == 'N'}" >
            <tr>
              <td>
                <div class="input-box showPlaceholder">
                  <input class="input-text phoneNum inputs" name="bookCount" id="bookCount" value="${bookCount}" type="text"/>
                </div>
          ...
          <tr style="display: none;">
            <td >
              <div class="input-box showPlaceholder" style="height: 40px;">
                <input id="captcha" class="input-text phoneNum fl  inputs" type="text" style="width: 200px;"/>
