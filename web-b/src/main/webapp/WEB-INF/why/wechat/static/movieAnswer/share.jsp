	...
	<script>
		...
		$(function () {
			...
			if (userHeadImgUrl.indexOf("http") == -1) {
            	...
            	var smallUrl = getIndexImgUrl(userHeadImgUrl, "_150_150");
                var bigUrl = getIndexImgUrl(userHeadImgUrl, "_300_300");
                var ImgObj = new Image();
                ImgObj.src = smallUrl;
                if (ImgObj.fileSize > 0 || (ImgObj.width > 0 && ImgObj.height > 0)) {
                	userHeadImgHtml = "<img src='"+smallUrl+"' width='210' height='210' onerror='imgNoFind();'/>";
                } else {
                	userHeadImgHtml = "<img src='"+bigUrl+"' width='210' height='210' onerror='imgNoFind();'/>";
                }
            } else {
