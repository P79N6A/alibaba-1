...
%>
	...
	<body>
		...
		<div class="content">
			...
			<div id="list">
				<div class="links links_one"><span>文化上海云<br>来了</span><em></em></div>
				...
				<div class="iphone">
					<div class="fix_img">
						<a href="http://m.wenhuayun.cn/wechat/index.do"><img src="${path}/STATIC/html/images/fixed.png" width="170" height="83"></a>
					</div>
					<div class="list_lh">
						<ul>
							<li>
								<a href="http://m.wenhuayun.cn/wechat/index.do"><img src="${path}/STATIC/html/images/scroll_2.png"></a>
							</li>
							<li>
								<a href="http://m.wenhuayun.cn/wechat/index.do"><img src="${path}/STATIC/html/images/scroll_3.png"></a>
							</li>
							<li>
								<a href="http://m.wenhuayun.cn/wechat/index.do"><img src="${path}/STATIC/html/images/scroll_4.png"></a>
							</li>
							<li>
								<a href="http://m.wenhuayun.cn/wechat/index.do"><img src="${path}/STATIC/html/images/scroll_5.png"></a>
							</li>
							<li>
								<a href="http://m.wenhuayun.cn/wechat/index.do"><img src="${path}/STATIC/html/images/scroll_6.png"></a>
							</li>
							<li>
								<a href="http://m.wenhuayun.cn/wechat/index.do"><img src="${path}/STATIC/html/images/scroll_7.png"></a>
							</li>
							<li>
								<a href="http://m.wenhuayun.cn/wechat/index.do"><img src="${path}/STATIC/html/images/scroll_8.png"></a>
							</li>
							<li>
								<a href="http://m.wenhuayun.cn/wechat/index.do"><img src="${path}/STATIC/html/images/scroll_9.png"></a>
							</li>
							<li>
								<a href="http://m.wenhuayun.cn/wechat/index.do"><img src="${path}/STATIC/html/images/scroll_10.png"></a>
							</li>
							<li>
								<a href="http://m.wenhuayun.cn/wechat/index.do"><img src="${path}/STATIC/html/images/scroll_11.png"></a>
							</li>
						</ul>
					</div>
				</div>
		...
		<script type="text/javascript">
			$(function() {
				...
				if ($s_width > 750) {
					...
					$('.fix_img a,.list_lh ul li a').attr('href', 'http://m.wenhuayun.cn/wechat/index.do');
				}
			})
		</script>
		<!-- 导入统计文件 -->
