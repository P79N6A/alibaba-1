        ...
        if (is_weixin()) {
            ...
            wx.ready(function () {
            	...
            	wx.onMenuShareAppMessage({
                    ...
                    link: '${basePath}/wxUser/silentInvoke.do?type=' + magazine_url,
                    imgUrl: imgUrl
                });
            	...
            	if (!is_weixin()) {
                	...
                	if (/wenhuayun/.test(ua)) {		//APP端
                		if(!appsdk_UserIsLogin()){
                			dialogAlert('系统提示', '登录之后才能分享！');
                    		return;
                		}else{
                			userId = JSON.parse(appsdk_getUserInfo()).userid;
                		}
                	}else{		//H5
                		location.href = '${path}/muser/login.do?type=' + magazine_url;
                		return;
                	}
            	}else{
            		window.location.href = '${path}/wxUser/silentInvoke.do?type=' + magazine_url;
                    return;
            	}
            }
