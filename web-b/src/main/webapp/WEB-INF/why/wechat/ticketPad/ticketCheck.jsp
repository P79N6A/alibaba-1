	...
	<div class="main ipad" style="overflow: auto;">
		<div class="content ipad-middle">
			<div class="logo2" style="margin-top: 100px;">
				...
				<p style="color: #5e648f;font-size: 100px;margin: 50px 0px;">文化云自助验票</p>
			</div>
			<div class="ipad-user">
				<div class="ipad-user-name" ms-controller="dataForm">
					<input type="text" style="width: 930px;" type="tel" placeholder="请输入取票码" id="orderValidateCode" value="${orderNumber}" maxlength="18"/>
				</div>
