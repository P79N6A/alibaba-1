    ...
    <div class="list_block" id="userInfoDiv">
        ...
        <div class="set_block set_nbg clearfix">
            ...
            <input id="order_code" class="fs28" type="text" style="float:left;height: 52px;border: none;"
                   placeholder="请输入6位验证码" maxlength="6"></input>
        ...
        <div class="set_block set_nbg clearfix">
            ...
            <input id="order_name" class="fs28" type="text" style="float:left;height: 52px;border: none;"
                   placeholder="预订人姓名" maxlength="20"></input>
        </div>
...
//            },
//            type: 'POST',
//            url: "http://192.168.41.154:10019/order/add",
//            contentType: "application/json; charset=utf-8",
//            data: {
//                activityId: activityId,
//                userId: userId,
//                eventId: eventId,
//                orderVotes: bookCount,
//                orderPhoneNo: $("#order_phone").val(),
//                orderName: userName
//            },
//            dataType: 'jsonp',
...
//        });
      ...
      $.post("${path}/wechatActivity/wcActivityOrderTest.do", {
        activityId: activityId,
                userId: userId,
