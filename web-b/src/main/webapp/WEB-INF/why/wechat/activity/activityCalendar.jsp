...
<head>
        ...
        if (is_weixin()) {
            ...
            wx.ready(function () {
                wx.onMenuShareAppMessage({
                    ...
                    link: '${basePath}/wxUser/silentInvoke.do?type=${path}/wechatActivity/preActivityCalendar.do'
                });
        ...
        function loadData(index, pagesize) {
        	...
        	if(tabType==1){	//日周月
                ...
                $.post("${path}/wechatActivity/wcActivityCalendarList.do", data, function (data) {
                	if(data.status==100){
                		...
                		$.each(data.data, function (i, dom) {
                			...
                			tagHtml += "</ul>"
                			$("#index_list").append("<li id="+dom.activityId+" activityId="+dom.activityId+">" +
        												"<img class='lazy' src='${path}/STATIC/wechat/image/placeholder.png' data-original='" + activityIconUrl + "' width='750' height='475'/>" +
        												"<img src='${path}/STATIC/wechat/image/蒙板.png' class='masking' onclick='showActivity(\"" + dom.activityId + "\")'/>" +
        												collectHtml +
                ...
                $.post("${path}/wechatActivity/wcMonthActivityList.do", data, function (data) {
                	if(data.status==100){
                		...
                		$.each(data.data, function (i, dom) {
                			...
                			$("#index_list").append("<li id="+dom.activityId+" activityId="+dom.activityId+">" +
        												...
        												time +
        												collectHtml +
        												"<span class='tab-po1'>"+dom.activityName+"</span>" +
        												"<span class='tab-po2'>"+dom.activityLocationName+"</span>" +
        											"</li>");
                		});
                	...
                	if(data.status==200){
                		window.location.href = '${path}/muser/login.do?type=${path}/wechatActivity/preActivityCalendar.do';
		                return;
                	}
                }, "json");
	...
	<style>
		...
		.menu-data {background: url(${path}/STATIC/wechat/image/menu-icon01.png) no-repeat -211px center;;}
	</style>
</head>
<body>
	<div class="main">
			...
			<div class="footer-menu">
				<div class="footer-menu-list">
					<ul>
						...
						<li><a><div class="menu-data"></div><p class="c7279a0">日历</p></a></li>
