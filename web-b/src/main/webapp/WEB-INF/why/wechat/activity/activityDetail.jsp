        ...
        $(function () {
            ...
            $.post("${path}/wechatActivity/activityWcDetail.do", {activityId: activityId,userId: userId}, function (data) {
                if (data.status == 0) {
                    ...
                    var tagNames = data.data1;
                    for (var i = 0; i < tagNames.length; i++) {
                        $("#tagNames").append("<li>" + tagNames[i].tagName + "</li>");
                    }
                    ...
                    for (var i = 0; i < timeQuantums.length; i++) {
                    ...
                    wx.ready(function () {
                        wx.onMenuShareAppMessage({
                            title: "我在文化云免费预订了一个超棒的文化活动-["+activity.activityName+"]",
                            desc: '现汇聚上海22万场文化活动及场馆资源',
                            imgUrl: getIndexImgUrl(activity.activityIconUrl, "_750_500"),
                            success: function () { 
        ...
        function addComment() {
            if (userId == null || userId == '') {
                ...
                if (status == 2) {
                    ...
                    window.location.href = "${path}/wechat/preAddWcComment.do?moldId=" + activityId + "&type=2";
                }
            }
        }
