...
<script>
	...
	$(function(){
	  ...
	  function loadData(index, pagesize,userId) {
		  $.post("${path}/wechatUser/userIntegralDetailAll.do",{pageIndex:index,pageNum:pagesize,userId:userId}, function (data) {
		...
		<div class="main">
			...
			<div class="content padding-bottom0 margin-top100">
				<div class="my-point bg7279a0 cfff">
					<p class="fs30 my-point-num">您有<span class="fs80 margin-left10 margin-right10">${integralNow }</span>积分</p>
