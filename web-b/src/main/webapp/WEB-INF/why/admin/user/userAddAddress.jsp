...
//                    }
                    ...
                    $.post("${path}/sysUserAddress/addAddress.do", $("#addAddress").serialize(),
                            function (data) {
    ...
    <div class="main-publish tag-adds">
        <table width="100%" class="form-table">
            <%--<tr>--%>
                ...
                <%--<td class="td-input">--%>
                    <%--<input type="text" value="" id="activitySite" name="activitySite" placeholder="活动举办的场所名称，如：“中华艺术宫”"--%>
            ...
            <tr>
                ...
                <td class="td-input">
                    <input type="text" value="" id="activityAddress" name="activityAddress" placeholder="街道+门牌号，如：“广中西路777弄10号楼”"
                           class="input-text w510"/>
                </td>
            </tr>
            <tr>
                ...
                <td class="td-input td-coordinate" id="LonLabel">
                    <input type="text" value="" data-val="X" id="activityLon" name="activityLon" class="input-text w120"
                           onkeyup="if(isNaN(value))execCommand('undo')"
                           onafterpaste="if(isNaN(value))execCommand('undo')" readonly="readonly"/>
                    <span class="txt">X</span>
                    <input type="text" value="" data-val="Y" id="activityLat" name="activityLat" class="input-text w120"
                           onkeyup="if(isNaN(value))execCommand('undo')"
                           onafterpaste="if(isNaN(value))execCommand('undo')" readonly="readonly"/>
