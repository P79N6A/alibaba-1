...
<form id="sys_form" action="" method="post">
	<input type="hidden" name="sid" value="${cmsSensitiveWords.sid}"/>
			...
			<table width="100%" class="form-table">
				...
				<tr>
					...
					<td class="td-input"  id="sensitiveWordsLable">
						<input type="text"  value="${cmsSensitiveWords.sensitiveWords}"  id="sensitiveWords" name="sensitiveWords" class="input-text w220" maxlength="20" />
					</td>
				</tr>
			...
			<div class="con-box-tlp">
				<div class="form-box">
					<table class="form-table">
						<tbody>
						<tr>
							<td class="td-title" width="120"><span class="td-prompt">*</span>敏感词：</td>
							<td class="td-input-two"  id="sensitiveWordsLable"><input type="text" value="${cmsSensitiveWords.sensitiveWords}" id="sensitiveWords" name="sensitiveWords"/></td>
						</tr>
						<tr class="submit-btn">
							<td colspan="2">
...
<script type="text/javascript">
	...
	seajs.use(['jquery'], function ($) {
		$(function () {
			...
			$(".btn-save").on("click", function(){
				...
				$.post("${path}/sensitiveWords/saveEditSensitiveWords.do", $("#sys_form").serialize(), function(
						datas) {
					if (datas == "success") {
	...
	/*
	 ...
	 $.post("${path}/sensitiveWords/saveEditSensitiveWords.do", $("#sys_form").serialize(), function(data) {
	 if (data == "success") {
