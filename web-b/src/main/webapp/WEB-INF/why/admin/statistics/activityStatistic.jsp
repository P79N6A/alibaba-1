...
<script type="text/javascript">
    ...
    function formSub()
    {
        $.post("/statistics/getActivityStatisticData.do", $("#activityForm").serialize(),
                function(data) {
                    $("tbody").empty();
                    ...
                    {//class="odd"
                        ...
                        c4 += parseInt(json[i]["val4"])
                        c5 += parseInt(json[i]["val5"])
                        $("tbody").append("<tr  "+((i%2==0)?"class=\"odd\"":"")+"><td>"+json[i]["cdate"]+"</td><td>"+json[i]["val1"]+"</td><td>"+json[i]["val2"]+"</td><td>"+json[i]["val3"]+"</td><td>"+json[i]["val4"]+"</td><td>"+json[i]["val5"]+"</td></tr>")
                    }
                    a1 = Math.floor(c1/json.length);
                    a2 = Math.floor(c2/json.length);
                    a3 = Math.floor(c3/json.length);
                    a4 = Math.floor(c4/json.length);
                    a5 = Math.floor(c5/json.length);
                    $("tbody").append("<tr  class=\"odd\"><td>合计</td><td>"+c1+"</td><td>"+c2+"</td><td>"+c3+"</td><td>"+c4+"</td><td>"+c5+"</td></tr>");
                    $("tbody").append("<tr  class=\"odd\"><td>平均值</td><td>"+a1+"</td><td>"+a2+"</td><td>"+a3+"</td><td>"+a4+"</td><td>"+a5+"</td></tr>");
