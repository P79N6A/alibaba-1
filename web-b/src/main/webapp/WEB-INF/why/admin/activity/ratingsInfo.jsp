    ...
    <script type="text/javascript">
	    ...
	    $(function () {
	        ...
	        $(".btn-publish").on("click", function () {
                ...
                }else if(type!=undefined&&type=='gather'){
                	parent.formSub('#gatherForm');
                	$("body", parent.document).find('body:gt(0)').remove();
                }
	        });
	    });
	                ...
	                <div class="con-box-tlp">
	                    <div class="form-box">
	                        <table class="form-table">
	                            <tbody>
	                            <tr style="padding-left:120px;display:block; margin-top:20px;">
	                            ...
	                            <tr class="td-btn" style="margin-top:15px;">
	                                <td colspan="2">
	                                	<input type="button" value="保存" onclick="editRatingsInfo()" class="btn-save" style="margin-left: 135px;margin-top: 20px;"/>
	                                    <input type="button" value="返回" class="btn-publish btn-cancel"/>
	                                </td>
	                            </tr>
	                            </tbody>
	                        </table>
