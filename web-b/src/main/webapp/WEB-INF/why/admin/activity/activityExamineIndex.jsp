                    ...
                    <td class="title">
                        ...
                        <c:if test="${not empty avct.activityName}">
                            <c:if test="${avct.activityState ==6}">
                                <a target="_blank" title="${avct.activityName}" href="javascript:toActivityView('${avct.activityId}')">
                            </c:if>
                                ...
                                <c:if test="${avct.sysNo=='0'||empty avct.sysNo}">
                                	<c:if test="${empty backPath}">
	                                    <%if (activityPreEditButton) {%>
	                                    	<a target="main" href="${path}/activity/preEditActivity.do?id=${avct.activityId}">编辑</a> |
	                                    <%}%>
	                            	</c:if>
                                </c:if>
