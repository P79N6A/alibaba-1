        ...
        <tr>
          ...
          <td>
           ...
           <c:if test="${avct.orderPayStatus == 1}"> <!--有效-->
            ...
            <c:if test="${avct.orderPayStatus ==2 && (avct.orderPaymentStatus ==2|| avct.orderPaymentStatus ==3)}">
									 	<%
										if (activityOrderRefundSuccessButton) {
									
										%>
										| <a target="_blank"
										onclick="refundSuccess('${avct.activityOrderId}')">完成退款</a>
									 	<%
										}
									%>
								 </c:if>	
