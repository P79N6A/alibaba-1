        ...
        <table width="100%" class="form-table">
            ...
            <tr>
                ...
                <td class="td-upload">
                    ...
                    <div id="advertImgShow_750_250_600_320" class="controls"
...
<script type="text/javascript">
    ...
    app.controller("advCon", function ($scope, $http) {
        ...
        $scope.$watch("advert.advertImgUrl", function (value) {
            if (value) {
                $scope.advertImgShow = getIndexImgUrl(getImgUrl(value), "_750_250");
            }
        }, true);
                ...
                switch (data) {
                    case("success"):
                        dialogAlert("系统提示", "保存成功", function () {
                            parent.location.href = "../live/liveAdvertRecommendIndex.do";
                            dialog.close().remove();
                        });
                        break;
                    case("noLogin"):
