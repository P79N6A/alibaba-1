...
<body>
	...
	<form id="addFunction" method="post">
	        ...
	        <table width="100%" class="form-table">
	            <tr>
					...
					<td class="td-input" id="funNameLabel">
					    <input type="text" id="funName" name="funName" class="input-text w510"  maxlength="20"/>
					</td>
	            </tr>
				...
				<tr>
				    ...
				    <td class="td-input" id="funDescrLabel">
				        <textarea name="funDescr" id="funDescr" class="input-textarea w510" maxlength="255" style="max-width: 535px;max-height: 185px;"></textarea>
				    </td>
				</tr>
				...
				<tr>
				     ...
				     <td class="td-upload" >
				         <table>
				             <tr>
				                 <td>
				                      <input type="hidden"  name="funIconUrl" id="funIconUrl" value=""/>
	...
	<script type="text/javascript">
		function submitData(){
			$.post("${path}/function/addFunction.do", $("#addFunction").serialize(),function(data){
