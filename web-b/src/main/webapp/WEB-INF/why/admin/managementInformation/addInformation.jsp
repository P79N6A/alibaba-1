...
<ng-form id="infoFrom" novalidate
    ...
    <div class="main-publish">
        <table width="100%" class="form-table">
            ...
            <tr class="">
                <td width="100" class="td-title"><span class="red">*</span>资讯描述：</td>
                <td class="td-content">
...
<script type="text/javascript" src="${path}/STATIC/js/admin/information/addInformation.js?20171228"></script>
