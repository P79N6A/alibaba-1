                ...
                <tr>
                    ...
                    <td><a target="main"
                       ...
                       <a class="copyButton" id="copy${info.informationId}" data-clipboard-text=''
                           href="javascript:copyUrl(getFrontUrl()+'information/preInfo.do?informationId=${info.informationId}');">复制URL</a>
                        <script>
                        	$("#copy${info.informationId}").attr("data-clipboard-text",getFrontUrl()+'information/preInfo.do?informationId=${info.informationId}');
                        </script>
                    </td>
                </tr>
            </c:forEach>
