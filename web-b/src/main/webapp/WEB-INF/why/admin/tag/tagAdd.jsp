...
<div class="main-publish tag-add">
    ...
    <input id="tagType" type="hidden" name="tagType" value="${dictId}" >
...
<%--                   <span>
        ...
        <tr>
            ...
            <td class="td-input"><textarea id="tagNames" name="tagNames" rows="6" class="textareaBox w220"  style="resize: none;width: 235px;height:100px"></textarea>
            </td>
        ...
        <tr class="td-tag-check">
            ...
            <td>
                <label>
                    <input type="checkbox" value="1" name="tagRecommend"/>
                    <c:choose>
                        <c:when test="${tagType==2}">推荐至app用户勾选个性化标签页面</c:when>
                        <c:otherwise>将标签推荐至首页</c:otherwise>
                    </c:choose>
                </label>
            </td>
        </tr>
        ...
        $(function () {
            ...
            $(".btn-save").on("click", function(){
                ...
                if(typeof(type) == "undefined"||type==""){
                    dialogTypeSaveDraft("提示","请选择标签类别!",function(){
                    });
                    return;
                }else{
                    $("#msTypeErr").html("");
                ...
                if($.trim($("#tagName").val())==""){
                    dialogTypeSaveDraft("提示","请填写标签名称!",function(){
                        $("#tagName").focus();
                    });
                    return;
                }
