...
<head>
    ...
    $(function () { 
    	...
    	if(informationSort==2||informationSort==4){
            // 图片
    ...
    <div class="main-publish">
        <table width="100%" class="form-table">
         <tr> 	
			 ...
			 <td class="td-input" id="videoTitleLabel"><input type="text" name="detailTitle" value="${info.detailTitle }" class="input-text w510" maxlength="30"/></td>
		</tr>
          
            <tr>
                <td width="100" class="td-title">视频缩略图：</td>
                <td class="td-upload" >
                <table>
                    <tr>
                        <td>
	                            ...
	                            <div class="whyUploadVedio" id="webupload2">
									<div style="width: 700px;">
										...
										<div id="container2" style="clear:both;">
											...
											<pre style="font-size: 14px;color: #999;line-height: 25px;">Tip：可上传1张图片，尺寸不小于750 × 600，格式为jpg、jpeg、png、gif，大小不超过2M</pre>
										</div>
			 ...
			 <tr>
				 ...
				 <td class="td-input" id="videoContentLabel"><input type="text" name="detailContent" value="${info.detailContent }" class="input-text w510" maxlength="255"/></td>
			</tr>
