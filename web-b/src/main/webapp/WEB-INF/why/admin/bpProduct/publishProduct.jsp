      ...
      //视频回调    
        ...
        $(function () {
            $("#btnPublish").on("click", function () {
               if(checkValidation()){
            	   $.post("${path}/bpProduct/publishProduct.do", $("#addProductForm").serialize(),
                           function(data) {
            ...
            $("#test").on("click",function(){
            	var type = $("#showPicType [name='aliFile']").remove();
...
<body>
	...
	<div class="site">
	    <em>您现在所在的位置：</em>文化商城 &gt; 发布文化商城
	</div>
	<div class="site-title">发布文化商城</div>
	<form method="post" id="addProductForm" action="previewProduct.do" target="blank">
	    <%-- 基础路径 --%>
	        ...
	        <table width="100%" class="form-table">
	            <tr>
	                ...
	                <td class="td-input" id="productNameLabel">
	                    <input id="productName" name="productName" type="text" class="input-text w510" maxlength="20"/>
	            ...
	            <tr>
	                ...
	                <td class="td-tag">
	                    <dl>
	                        <input id="productModule" name="productModule" type="hidden"/>
	            ...
	            <tr>
	                ...
	                <td class="td-input" id="productContactmanLabel">
	                    <input id="productContactman" name="productContactman" type="text" class="input-text w260" maxlength="20"/>
	                    <span class="error-msg"></span>
	                </td>
	            </tr>         
	             ...
	             <tr>
	                ...
	                <td class="td-input" id="productContactWayLabel">
	                    <input id="productContactway" name="productContactway" type="text" class="input-text w260" maxlength="20"/>
	                    <span class="error-msg"></span>
	                </td>
	            </tr> 
	             ...
	             <tr>
	                ...
	                <td class="td-tag">
	               		<input id="productShowtype" name="productShowtype" type="hidden"/>
	                    <dl>
	                        <dd id="showTypeLabel">
	            ...
	            <tr id="showVideoType" style="display: none">
	                ...
	                <td id="productVideoLabel" class="td-upload">
							<div class="whyUploadVedio" id="productVideoWebupload">
								<div class="clearfix">
								<div id="ossfile2" style="width: 200px;float: left;" class="clearfix"></div>
									<div id="container2" style="clear: both;">
	            ...
	            <tr>
	                ...
	                <td class="td-input" id="productInfoLabel">
	                     <textarea name="productInfo" id="productInfo" rows="4" class="textareaBox"  maxlength="300" style="width: 500px;resize: none"></textarea>
	                </td>
	            </tr>
	            ...
	            <tr>
	                ...
	                <td class="td-content" id="productRemarkLabel">
	                    <div class="editor-box">
	                        <textarea name="productRemark" id="productRemark"></textarea>
	                    </div>
	                </td>
	            </tr>
	            <tr>
