...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
          	...
          	aliUploadImg('assnResVideoCover1Webupload', getAssnResVideoCovers, 1, true, 'H5');
        	aliUploadFiles('assnResVideoUrl1Webupload', getAssnResVideoUrls, 1, true, 'H5');
...
<body>
	<form id="assnForm" method="post">
		<input type="hidden" id="assnVideoUrl" name="assnVideoUrl" />
		<input type="hidden" id="assnVideoName" name="assnVideoName" />
	    <div class="site">
	        <em>您现在所在的位置：</em>社团管理 &gt;社团新增
	    </div>
	    <div class="site-title">新增社团</div>
	    <div class="main-publish">
	    	<div class="assnTitle">社团信息：</div>
	        <table width="100%" class="form-table">
		        <tr>
	                <td width="100" class="td-title"><span class="red">*</span>社团名称：</td>
	                <td class="td-input" id="assnNameLabel"><input type="text" id="assnName" name="assnName" class="input-text w510" maxlength="15"/></td>
	            </tr>
				<tr>
					<td width="100" class="td-title"><span class="red">*</span>社团标签：</td>
					<td class="td-input" id="assnTagLabel">
						<input type="text" id="assnTag1" name="assnTag" class="input-text w120" maxlength="4"/>
						<input type="text" id="assnTag2" name="assnTag" class="input-text w120" maxlength="4"/>
						<input type="text" id="assnTag3" name="assnTag" class="input-text w120" maxlength="4"/>
						<span style="color:#596988">（最多3个，每个不超过4个字）</span></td>
				</tr>
	            <tr>
	                <td width="100" class="td-title"><span class="red">*</span>社团简介：</td>
	                <td class="td-input" id="assnIntroduceLabel"><input type="text" id="assnIntroduce" name="assnIntroduce" class="input-text w510" maxlength="50"/></td>
	            </tr>
	            <tr>
		        	<td width="100" class="td-title"><span class="red">*</span>详细介绍：</td>
					<td class="td-input">
	                    <div class="editor-box">
	                        <textarea id="assnContent" name="assnContent" rows="5" class="textareaBox"  maxlength="1000" style="width: 500px;resize: none"></textarea>
	        ...
	        <div id="assnResVideos">
		        <table width="100%" class="form-table assnResVideos">
		        	<tr><td class="assnResVideosTitle"><img src="${path}/STATIC/image/remove.png"  width="30" height="30" onclick="removeVideos($(this));">视频1：</td><td><div class="assnVideo"  onclick="setMainVideo($(this))">设为主视频</div></td></tr>
			        <tr>
		                <td width="100" class="td-title">视频名称：</td>
		                <td class="td-input" id="assnResVideoNamesLabel"><input type="text" name="assnResVideoNames" class="input-text w510" maxlength="30"/></td>
		            </tr>
			        <tr>
						<td class="td-title">视频缩略图<span style='color:red'>(360*230)</span>：</td>
						<td>
							<div class="whyUploadVedio assnResVideoCoversDiv" id="assnResVideoCover1Webupload">
								<div class="clearfix">
									<div id="container2" style="float: left;overflow: hidden;margin: 10px 10px 10px 0;">
										<a id="selectfiles2" class="selectFiles btn">选择文件</a>
									</div>
					...
					<tr>
						<td class="td-title">上传视频：</td>
						<td>
							<div class="whyUploadVedio assnResVideoUrlsDiv" id="assnResVideoUrl1Webupload">
								<div class="clearfix">
									<div id="container2" style="float: left;overflow: hidden;margin: 10px 10px 10px 0;">
										<a id="selectfiles2" class="selectFiles btn">选择文件</a>
									</div>
	        ...
	        <table width="100%" class="form-table">
		        <tr>
	                ...
	                <td class="td-input" id="assnMemberLabel"><input type="number" id="assnMember" name="assnMember" class="input-text w310" maxlength="10"/></td>
	            </tr>
		        <tr>
	                <td width="100" class="td-title"><span class="red">*</span>初始粉丝数：</td>
	                <td class="td-input" id="assnFansInitLabel"><input type="number" id="assnFansInit" name="assnFansInit" class="input-text w310" maxlength="10"/></td>
	            </tr>
		        <tr>
	                <td width="100" class="td-title"><span class="red">*</span>初始浇花数：</td>
	                <td class="td-input" id="assnFlowerInitLabel"><input type="number" id="assnFlowerInit" name="assnFlowerInit" class="input-text w310" maxlength="10"/></td>
	            </tr>
	        </table>
	        ...
	        <table width="100%" class="form-table">
		        <tr>
	                ...
	                <td class="td-input" id="shareTitleLabel"><input type="text" id="shareTitle" name="shareTitle" class="input-text w510" maxlength="30"/></td>
	            </tr>
		        <tr>
	                <td width="100" class="td-title"><span class="red">*</span>分享简介：</td>
	                <td class="td-input" id="shareDescLabel"><input type="text" id="shareDesc" name="shareDesc" class="input-text w510" maxlength="50"/></td>
	            </tr>
	        </table>
