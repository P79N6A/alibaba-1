...
<head>
    ...
    <script type="text/javascript">
        function reload() {
            window.location.href = "${path}/beipiaoCarousel/carouselList.do?carouselType=${bpCarousel.carouselType}";
        }
        ...
        function reload() {
            ...
            window.location.href = "${path}/beipiaoCarousel/preEditCarousel.do?carouselId=" + id;
        }
...
<body>
<div class="site">
    <em>您现在所在的位置：</em>动态资讯 &gt; 编辑首页轮播图
</div>
<div class="site-title">编辑首页轮播图</div>
<div class="main-publish">
    ...
    <table width="100%" class="form-table">
        <tr>
            ...
            <td class="td-input" id="titleLabel">
                <input id="carouselTitle" name="carouselTitle" type="text" class="input-text w510"
                       value="${bpCarousel.carouselTitle }"/>
                <input id="carouselType" name="carouselType" type="hidden" value="${bpCarousel.carouselType}"/>
        ...
        <tr>
            ...
            <td class="td-input" id="pcurlLabel">
                <input id="pccarouselUrl" name="carouselUrl" type="text" class="input-text w510"
                       value="${bpCarousel.carouselUrl.split(',')[0]}"/>
                <span class="error-msg"></span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="td-input" id="h5urlLabel">
                <input id="h5carouselUrl" name="carouselUrl" type="text" class="input-text w510"
                       value="${bpCarousel.carouselUrl.split(',')[1]}"/>
                <span class="error-msg"></span>
            </td>
        </tr>
                                    ...
                                    <div style="width: 700px;">
                                        <div id="ossfile2">
                                            <div name="aliFile"
                                                ...
                                                <img style="max-height: 130px;max-width: 130px;position: absolute;left: 0;right: 0;top: 0;bottom: 0;margin: auto;"
                                                     src="${bpCarousel.carouselImage }"><br>
                                                <img onclick="remove(this);" id="aliRemoveBtn"
                                                ...
                                                <input id="carouselImage" name="carouselImage"
                                                       value="${bpCarousel.carouselImage }" type="hidden">
                                            </div>
                                        </div>
                                        <div id="container2" style="clear:both;">
                                            ...
                                            <pre style="font-size: 14px;color: #999;line-height: 25px;">Tip：可上传1张图片，建议尺寸<span
                                                    style="color:red">1200*400像素</span>，大小必须小于2M</pre>
                                        </div>
                                        <script type="text/javascript">
                                            // 图片
        ...
        <tr>
            ...
            <td class="td-btn">
                <input type="hidden" id="carouselId" name="carouselId" value="${bpCarousel.carouselId }"/>
                ...
                <input class="btn-publish" type="button" style="background-color:#C0C0C0 " onclick="returnList();"
                       value="返回"/>
            </td>
        </tr>
    </table>
