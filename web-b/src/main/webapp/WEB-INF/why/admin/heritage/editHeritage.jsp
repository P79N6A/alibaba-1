...
<head>
    ...
    <script type="text/javascript">
    	...
    	//加载图片
    	function loadHeritageImg(){
    		var heritageImg = '${heritage.heritageImg}';
    		if(heritageImg.length>0){
    			$.each(heritageImg.split(","),function(i,dom){
                	var imgSrc = getIndexImgUrl(getImgUrl(dom),"_750_500");
                	$("#heritageImgUl").prepend('<li heritageImgUrl="">' +
    						    	            	'<input type="hidden" name="heritageImgUrl" value="'+dom+'"/>' +
    						    					'<img class="feiyi-img" width="155" height="155" src="'+imgSrc+'"/>' +
    	...
    	function editHeritage(){
    	    ...
    	    if(heritageName==undefined||heritageName.trim()==""){
    	        ...
    	        $("#saveBut").attr("onclick","editHeritage();");
    	    ...
    	    if(heritageIntroduce==undefined||heritageIntroduce.trim()==""){
    	  	...
    	  	//保存活动信息
    	    $.post("${path}/heritage/editHeritage.do", $("#heritageForm").serialize(),function(data) {
   	            if(data.status==1) {
...
<body>
	<form id="heritageForm" method="post">
	    ...
	    <input type="hidden" name="heritageId" value="${heritage.heritageId}"/>
	    <input type="hidden" id="isCutImg" value="N"/>
	    
	    <div class="site">
	        <em>您现在所在的位置：</em>运维管理  &gt; 非遗管理  &gt; 编辑非遗
	    </div>
	    <div class="site-title">编辑非遗</div>
	    <div class="main-publish">
	        <table width="100%" class="form-table">
	            <tr>
	                <td width="100" class="td-title"><span class="red">*</span>非遗名称：</td>
	                <td class="td-input" id="heritageNameLabel"><input type="text" id="heritageName" name="heritageName" class="input-text w510" maxlength="20" value="${heritage.heritageName}"/></td>
	            </tr>
	            <tr>
	                ...
	                <td class="td-upload" id="heritageCoverImgLabel">
	                    <table>
	                        <tr>
	                            <td>
	                                <input type="hidden" name="heritageCoverImg" id="heritageCoverImg" value="${heritage.heritageCoverImg}">
	            ...
	            <tr>
		            ...
		            <td class="td-input search" id="heritageTypeLabel">
		                <div class="select-box w135" style="margin-left: 0;">
		                    <input type="hidden" name="heritageType" id="heritageType" value="${heritage.heritageType}"/>
		        ...
		        <tr>
		            ...
		            <td class="td-input search" id="heritageLevelLabel">
		                <div class="select-box w135" style="margin-left: 0;">
		                    <input type="hidden" name="heritageLevel" id="heritageLevel" value="${heritage.heritageLevel}"/>
		        ...
		        <tr>
		            ...
		            <td class="td-input search" id="heritageAreaLabel">
		                <div class="select-box w135" style="margin-left: 0;">
		                    <input type="hidden" name="heritageArea" id="heritageArea" value="${heritage.heritageArea}"/>
			    ...
			    <c:if test="${!fn:contains(basePath,'http://xcct.bj.wenhuayun.cn')}">
			        <tr>
			            ...
			            <td class="td-input search" id="heritageDynastyLabel">
			                <div class="select-box w135" style="margin-left: 0;">
			                    <input type="hidden" name="heritageDynasty" id="heritageDynasty" value="${heritage.heritageDynasty}"/>
                ...
                <td width="100" class="td-title">简介：</td>
	                <td class="td-input">
	                    <div class="editor-box">
	                        <textarea id="heritageIntroduce" name="heritageIntroduce" rows="5" class="textareaBox"  maxlength="2000" style="width: 500px;resize: none">${heritage.heritageIntroduce}</textarea>
	            ...
	            <tr>
	                ...
	                <td class="td-btn">
	                    <div class="room-order-info info2" style="position: relative;">
	                        <input id="saveBut" class="btn-publish" type="button" onclick="editHeritage()" value="保存"/>
	                    </div>
	                </td>
	            </tr>
	        </table>
