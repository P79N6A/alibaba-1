    ...
    <script type="text/javascript">
        ...
        function dictLocation(code) {
            ...
            if (code=='' && townArea == "市级自建"){
                // $("#venueArea").val("4300,市级自建");//并没有什么luan用
                code = 4300;
            }
            // 位置字典
          ...
          <!--  <tr>
            ...
            <tr style="display: none">
                ...
                <td class="td-input td-fees" id="venueHasAntiqueLabel">
                    <label>
                        <input type="radio" name="venueHasAntique" checked value="1"/><em>无</em>
                    </label>
                    <label>
           ...
           <!-- <tr>
            ...
            <tr>
				...
				<td class="td-input" id="venueSortLabel">
					<input id="venueSort" name="venueSort" type="text" class="input-text" escapeXml="true" maxlength="11"/>
					<span class="error-msg"></span>
				</td>
			</tr>
            <tr>
