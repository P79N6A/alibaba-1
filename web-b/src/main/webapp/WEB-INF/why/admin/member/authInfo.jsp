...
<head>
    ...
    <script type="text/javascript">
        ...
        function refuse(){
        	...
        	dialog(
    				{
    					url : '${path}/terminalUser/authRefuse.do?userId='+userId+'&roomOrderId='+roomOrderId+"&userIsDisable="+userIsDisable,
    					title : '填写拒绝理由',
    					width : 520,
    					height : 240,
    					fixed : true
	        	 ...
	        	 $.post('${path}/terminalUser/authDo.do',data,function(result){
	        		 if(result>=0)
	        		{
	        		 	if(roomOrderId)
	        				...
	        				window.location.href = '${path}/terminalUser/terminalUserIndex.do?userType=3&userIsDisable='+userIsDisable;
	        			else 
