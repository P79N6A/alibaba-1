		...
		<script type="text/javascript">
		  seajs.use(['${path}/STATIC/js/dialogBack/src/dialog-plus'], function (dialog) {
			...
			function check(){
				...
				var topicTitle = $("#topicTitle").val().replace(/\ +/g,"").replace(/[ ]/g,"").replace(/[\r\n]/g,"");
				...
				if($("#isDrawYes").get(0).checked){
					...
					var drawRule=$("#drawRule").val();
					
					if(drawRule.length > 50){
						removeMsg("drawRuleLabel");
						appendMsg("drawRuleLabel","最多不超过50个汉字!");
						$("#drawRule").focus();
						return false;
					}
					else
