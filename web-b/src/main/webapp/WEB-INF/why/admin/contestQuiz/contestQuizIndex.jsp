...
<head>
    ...
    <script type="text/javascript">
        ...
        function copy(topicId){
        	var clipBoardContent='bp.ln.wenhuayun.cn/wechatStatic/contestQuiz.do?topicId=';
        	clipBoardContent+=clipBoardContent+topicId;
            ...
            <c:forEach items="${contestTopicList}" var="contestTopic" varStatus="status">
                <tr>
                    ...
                    <td>
                    		...
                    		<a target="main" data-clipboard-text='bp.ln.wenhuayun.cn/wechatStatic/contestQuiz.do?topicId=${contestTopic.topicId}' class="copyButton" onclick="copy('${contestTopic.topicId}')">复制链接</a> |
