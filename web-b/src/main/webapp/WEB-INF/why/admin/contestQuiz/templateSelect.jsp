                            ...
                            <tr style="padding-left:80px;display:block; margin-top:20px;">
                                <c:forEach items="${list}" var="template" varStatus="sta">
                                    ...
                                    <td class="td-input" style="display:inline-block;font-size: 13px;margin-right:20px">
                                      ...
                                      <img src="${template.coverImgUrl}@300w" alt="" height="150" width="100" style="max-height: 50;max-width: 100">      
                                               
                                               
                                               <img src="${template.backgroundImgUrl}@300w" alt="" height="150" width="100" style="max-height: 50;max-width: 100">
                                               </td>
