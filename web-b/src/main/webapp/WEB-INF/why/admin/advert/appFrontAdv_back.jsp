...
<div class="main-publish" id="dataList">
                        ...
                        <td colspan="4">
                            <div class="A1-edit">
                                <div class="edit-btn">
                                    ...
                                    <img onclick="advEdit('2_A_1','_750_250')" src="" width="498" height="200"
                    ...
                    <ul>
                        <c:if test="${empty listB}">
                            <c:forEach var="i" begin="1" end="12">
                                <li>
                                    <div class="edit-btn">
                                        <a onclick="advEdit('2_B_${i}','_140_120')">
                                            <img src="" imgVal=""
                                                 imgSize="_140_120"/>
                                            <div class="A1-p">
                                                <p>B${i}</p>
                        ...
                        <td colspan="2">
                            <div class="A2-edit">
                                <div class="edit-btn">
                                    ...
                                    <a onclick="advEdit('2_A_${i}','_750_440')">
                                        <img src="" imgVal="${advert.advertImgUrl}"
                                             imgSize="_750_440"/>
                                        <div class="A1-p">
                                            <p>A${i}</p>
                        ...
                        <td width="125">
                            <div class="A3-edit">
                                <div class="edit-btn">
                                    ...
                                    <a onclick="advEdit('2_A_${i}','_374_430')">
                                        <img src="" imgVal="${advert.advertImgUrl}"
                                             imgSize="_374_430"/>
                                        <div class="A1-p">
                                            <p>A${i}</p>
            ...
            <c:if test="${empty listC}">
                <c:forEach var="i" begin="1" end="8">
                    <td width="125">
                        <div class="C-edit">
                            <div class="edit-btn">
                                <a onclick="advEdit('2_C_${i}','_140_120')">
                                    <img src=""
                                         imgVal=""
                                         imgSize="_300_190"/>
                                    <div class="A1-p">
    ...
    <table class="form-table part2-table" style="float: left;margin-left: 50px;margin-top: 50px;width: 500px;">
        <tbody style="width: 500px;">
        <tr>
            <th colspan="2" style="text-align: left;">运营位链接列表：</th>
        </tr>
        <tr>
            <td width="100">运营位置zxc</td>
