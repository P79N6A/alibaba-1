    ...
    <div class="main-publish tag-add">
        <table width="100%" class="form-table">
            <tr>
                ...
                <td class="td-select">
                    <div class="select-box w240">
                        <input type="hidden" id="displayPosition" name="displayPosition"
                               value="${record.displayPosition}"/>
            ...
            <tr>
                ...
                <td class="td-input">
                    <input type="text" id="advertTitle" name="advertTitle" value="${cmsAdvert.advertTitle}"
                           maxlength="10" class="input-text w220"/>
                </td>
            </tr>
            <tr>
                <td width="28%" class="td-title">内容简介：</td>
                <td class="td-input">
                    <textarea name="advertContent" class="textareaBox" rows="7" maxlength="30"
                              style="width: 350px;resize: none">${record.advertContent}</textarea>
                </td>
            </tr>
            <tr>
                ...
                <td class="td-input">
                    <input type="text" id="advertConnectUrl" name="advertConnectUrl"
                           value="${cmsAdvert.advertConnectUrl}" class="input-text w220"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="td-upload" id="activityIconUrlLabel">
                    <table>
                        <tr>
                            <td width="80"><span id="imgShow"><input type="hidden" name="" id="" value=imgs/></span>
                            </td>
                            <td>
