...
<head>
    ...
    <script type="text/javascript">
        ...
        function doQuery() {
            ...
            $.post("${path}/activityStatistics/queryActivityVenueData.do",$("#jvm").serialize(), function (data) {
                list = eval(data);

                for (var i = 0; i < list.length; i++) {
                    var obj = list[i];
                    var dictName = obj.venueName;
...
<body>
<div class="site">
    <em>您现在所在的位置：</em>数据管理 &gt; 活动数据统计 &gt; 安康市场馆活动情况
</div>
    ...
    <form id="jvm">
        ...
        <div class="form-table" style="float: right;width: 620px;">
            <div class="td-time" style="margin-top: 0px;">
                <input type="hidden" value="${data.dictId}" name="dictId">
