...
<head>
    ...
    <script type="text/javascript">
        ...
        function doQuery() {
            ...
            $.post("${path}/activityStatistics/queryLocationData.do",$("#jvm").serialize(), function (data) {
                list = eval(data);
                ...
                for (var i = 0; i < list.length; i++) {
                    ...
                    $("#Area_Info").append('<tr><td width="10%">' + dictName + '</td>' +
                        ...
                        '<td width="10%"><a href="${path}/activityStatistics/activityVenueStatisticsIndex.do?dictId='+obj.dictId+"&"+$("#jvm").serialize()+'">查看场馆数据</a></td></tr>'
                    );
...
<body>
<div class="site">
    <em>您现在所在的位置：</em>数据管理 &gt; 活动数据统计 &gt; 各街镇活动情况
</div>
<div class="site-title">街镇信息数据</div>
        ...
        <div class="form-table" style="float: right;width: 620px;">
            <div class="td-time" style="margin-top: 0px;">
                ...
                <div class="select-box w110" id="activity-select-ul" style="float: left">
                    <input type="hidden" name="queryType" id="queryType" value="${data.queryType}"/>
