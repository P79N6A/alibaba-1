...
<head>
    ...
    <script type="text/javascript">
        ...
        function doQuery() {
            ...
            $.post("${path}/activityStatistics/queryAreaData.do",$("#jvm").serialize(), function (data) {
                list = eval(data);

                for (var i = 0; i < list.length; i++) {
                    var obj = list[i];
                    var Area = obj.area.split(',')[1];
                    ...
                    $("#Area_Info").append('<tr><td width="10%">' + Area + '</td>' +
                        ...
                        '<td width="10%"><a href="${path}/activityStatistics/activityLocationStatisticsIndex.do?area='+obj.area.split(',')[0]+"&"+$("#jvm").serialize()+'">查看街镇数据</a></td></tr>'
                    );
            ...
            <div class="td-time" style="margin-top: 0px;">
                ...
                <div id="times">
                    <div class="start w240" style="margin-left: 30px;">
                        ...
                        <input type="text" id="activityStartTime" name="activityStartTime" readonly/>
