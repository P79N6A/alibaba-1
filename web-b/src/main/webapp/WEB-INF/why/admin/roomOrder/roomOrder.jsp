	         ...
	         dialogConfirm("提示", html, function(){
	           $.post("${path}/cmsRoomOrder/cancelRoomOrder.do",{"roomOrderId":roomOrderId}, function(data) {
	             if (data!=null && data=='success') {
	              // window.location.href="${path}/cmsRoomOrder/roomOrderCheckIndex.do";roomOrderForm
				...
				<tbody>
					...
					<c:forEach items="${roomOrderList}" var="roomOrder"
						...
						<tr>
							...
							<td><c:if test="${roomOrder.bookStatus==1 }">
								审核通过
							</td>
							</c:if>
							...
							<td>
								<a target="main"
                                      href="${path}/cmsRoomOrder/roomOrderDetail.do?roomOrderId=${roomOrder.roomOrderId}">编辑</a> |
