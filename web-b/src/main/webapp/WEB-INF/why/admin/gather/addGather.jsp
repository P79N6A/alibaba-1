...
<head>
    ...
    <script type="text/javascript">
    	...
    	function saveGather(){
    	    ...
    	    if(!checkInfo(gatherType,"gatherType","活动标签为必选项！")) return;
...
<body>
	<form id="gatherForm" method="post">
	    ...
	    <div class="site">
	        <em>您现在所在的位置：</em>运维管理  &gt; 新增采集活动
	    </div>
	    <div class="site-title">新增采集活动</div>
	    <div class="main-publish">
	    	<table width="100%" class="form-table">
	            <tr>
	            	<td width="100" class="td-title"><span class="red">*</span>活动名称：</td>
	                <td class="td-input" id="gatherNameLabel">
	                	<input type="text" id="gatherName" name="gatherName" class="input-text w510" maxlength="50"/>
	                </td>
	            </tr>
	            <tr>
		            ...
		            <td class="td-tag">
		            	...
		            	<input type="hidden" name="gatherTag" id="gatherTag"/>
		            </td>
	            </tr>
	            <tr>
		            ...
		            <td class="td-tag">
		            	...
		            	<input type="hidden" name="gatherType" id="gatherType"/>
		            </td>
	            </tr>
	        </table>
	        
	        <table width="100%" id="commonGatherTable" class="form-table" style="display: none;">
	            <tr>
	            	<td width="100" class="td-title"><span class="red">*</span>活动地址：</td>
		            <td width="560" class="td-input" id="gatherAddressLabel">
		                <input type="text" id="activityAddress" name="gatherAddress" class="actPlace input-text w510" placeholder="街道+门牌号，如：“广中西路777弄10号F楼”" readonly>
		            </td>
		            <td class="td-input">
	            ...
	            <tr>
	                ...
	                <td class="td-input" id="gatherTimeLabel">
	                	<input type="text" id="gatherTime" name="gatherTime" class="input-text w510" maxlength="50"/>
	                </td>
	            </tr>
	            <tr>
	            	<td width="100" class="td-title"><span class="red">*</span>主办/演出：</td>
	                <td class="td-input" id="gatherHostLabel">
	                	<input type="text" id="gatherHost" name="gatherHost" class="input-text w510" maxlength="50"/>
	                </td>
	            </tr>
	            <tr>
	            	<td width="100" class="td-title"><span class="red">*</span>票价：</td>
	                <td class="td-input" id="gatherPriceLabel">
	                	<input type="text" id="gatherPrice" name="gatherPrice" class="input-text w310" maxlength="20"/>
	                </td>
	            </tr>
	        </table>
	        
	        <table width="100%" id="movieGatherTable" class="form-table" style="display: none;">
	            <tr>
	            	<td width="100" class="td-title"><span class="red">*</span>影片类型：</td>
		            <td class="td-input" id="gatherMovieTypeLabel">
	                	<input type="text" id="gatherMovieType" name="gatherMovieType" class="input-text w510" maxlength="50"/>
	                </td>
	            </tr>
	            <tr>
	            	<td width="100" class="td-title"><span class="red">*</span>时长：</td>
	                <td class="td-input" id="gatherMovieTimeLabel">
	                	<input type="text" id="gatherMovieTime" name="gatherMovieTime" class="input-text w310" maxlength="20"/>
	                </td>
	            </tr>
	            <tr>
	            	<td width="100" class="td-title"><span class="red">*</span>主演/配音：</td>
	                <td class="td-input" id="gatherMovieActorLabel">
	                	<input type="text" id="gatherMovieActor" name="gatherMovieActor" class="input-text w510" maxlength="100"/>
	                </td>
	            </tr>
	            <tr>
	            	<td width="100" class="td-title"><span class="red">*</span>导演：</td>
	                <td class="td-input" id="gatherMovieDirectorLabel">
	                	<input type="text" id="gatherMovieDirector" name="gatherMovieDirector" class="input-text w510" maxlength="20"/>
	                </td>
	            </tr>
	        </table>
	        ...
	        <table width="100%" class="form-table">
	        			...
	        			<div class="form-table" style="float: left;" id="gatherDateLabel">
				            <div class="td-time" style="margin-top: 0px;">
				                <div class="start w240">
				                    ...
				                    <input type="text" id="gatherStartDate" name="gatherStartDate" readonly/>
				                ...
				                <div class="end w240">
				                    ...
				                    <input type="text" id="gatherEndDate" name="gatherEndDate" readonly/>
	            ...
	            <tr>
	                ...
	                <td class="td-upload" id="gatherImgLabel">
	                    <table>
	                        <tr>
	                            <td>
	                                <input type="hidden" name="gatherImg" id="gatherImg" value="">
	            ...
	            <tr>
		            ...
		            <td class="td-input search" id="gatherGradeLabel">
		                <div class="select-box w135" style="margin-left: 0;">
		                    <input type="hidden" name="gatherGrade" id="gatherGrade"/>
		        ...
		        <tr>
	                ...
	                <td class="td-input" id="gatherLinkLabel">
	                	<input type="text" id="gatherLink" name="gatherLink" class="input-text w510" maxlength="200"/>
	                </td>
	            </tr>
	        </table>
