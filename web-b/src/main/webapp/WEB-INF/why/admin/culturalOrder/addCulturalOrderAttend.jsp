...
function saveCulturalOrder(){
	...
	if (culturalOrderMustKnow == undefined || culturalOrderMustKnow == "") {
        ...
        appendMsg("culturalOrderMustKnowLabel", "报名须知为必填项!");
	  	...
	  	<table width="100%" class="form-table assnResVideos">
	        ...
	        <tr class="eventTr">
	            ...
	            <td class="td-time td-input td-online">
	                ...
	                <input id="startHour" name="startHour" min="0" type="number" class="input-text w64" maxlength="2"/>：
	                <input id="startMinute" name="startMinute" min="0" type="number" class="input-text w64" maxlength="2"/>至
	                <input id="endHour" name="endHour" min="0" type="number" class="input-text w64" maxlength="2"/>：
	                <input id="endMinute" name="endMinute" min="0" type="number" class="input-text w64" maxlength="2"/>
                	<em>票数：</em><input id="ticketNum" name="ticketNum" type="number" min="0" class="input-text w64"/>
