...
<body>
	<form id="poemLectorForm" method="post">
		<input type="hidden" name="lectorId" value="${poemLector.lectorId}"/>
	    <div class="site">
	        <em>您现在所在的位置：</em>运维管理 &gt; 每日一诗管理  &gt;讲师编辑
	    </div>
	    <div class="site-title">编辑讲师</div>
	    <div class="main-publish">
	        <table width="100%" class="form-table">
		        <tr>
	                <td width="100" class="td-title"><span class="red">*</span>讲师名称：</td>
	                <td class="td-input" id="lectorNameLabel"><input type="text" id="lectorName" name="lectorName" class="input-text w510" maxlength="20" value="${poemLector.lectorName}"/></td>
	            </tr>
	            <tr>
							...
							<div class="clearfix">
								...
								<div id="ossfile2" style="width: 200px;float: left;" class="clearfix">
									<div name="aliFile" style="position: relative;">
										<img class="aliFileImg" src="${poemLector.lectorHeadImg}" style="max-height: 130px;max-width: 130px;position: absolute;left: 0;right: 0;top: 0;bottom: 0;margin: auto;">
										<input type="hidden" name="lectorHeadImg" value="${poemLector.lectorHeadImg}">
	            ...
	            <tr>
	                ...
	                <td class="td-input" id="lectorJobLabel"><input type="text" id="lectorJob" name="lectorJob" class="input-text w510" maxlength="50" value="${poemLector.lectorJob}"/></td>
	            </tr>
	            <tr>
		        	<td width="100" class="td-title"><span class="red">*</span>个人简介：</td>
					<td class="td-input">
	                    <div class="editor-box">
	                        <textarea id="lectorIntro" name="lectorIntro" rows="5" class="textareaBox"  maxlength="500" style="width: 500px;resize: none">${poemLector.lectorIntro}</textarea>
