    ...
    <div class="table-cont">
        <table width="100%" class="tab-data" id="Area_Info" ng-switch="selMod">
            ...
            <tr ng-repeat="x in resData">
                ...
                <td ng-switch="area.district">
                    <a ng-switch-when="0" ng-bind="x.val4"></a>
                </td>
...
<script type="text/javascript"
        src="${path}/STATIC/js/admin/statistics/venuePublicStatistics.js?version=yui"></script>
