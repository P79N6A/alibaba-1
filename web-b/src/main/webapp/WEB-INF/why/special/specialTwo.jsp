...
<div id="monkey_special">
    <div class="monkey_specialbg">
        <!--top start-->
        <div class="top_tit">
            <a href="#"><img src="${path}/STATIC/special/image/special_b2.png" width="1152" height="102"/></a><span
                class="icon_one"></span><span class="icon_two"></span><span class="icon_three"></span><span
                class="icon_four"></span>
        </div>
        <!--top end-->
        <!--list start-->
        <div id="monkey_list">
                    ...
                    <li>
                        ...
                        <div class="info">
                            ...
                            <div class="text">
                                ...
                                <p>时间：
                                    <fmt:parseDate value="${activity.activityStartTime}" pattern="yyyy-MM-dd"
                                                   var="startTime"/>
                                    <fmt:parseDate value="${activity.activityEndTime}" pattern="yyyy-MM-dd"
                                                   var="endTime"/>
                            ...
                            <div class="number">
                                ...
                                <span class="view"><i></i><c:if test="${empty activity.yearBrowseCount}">0</c:if><c:if
                                        test="${not empty activity.yearBrowseCount}">${activity.yearBrowseCount}</c:if></span>
                            </div>
                        </div>
                    </li>
                </c:forEach>
