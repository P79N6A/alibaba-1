...
//                if (map.success=='Y') {
                    ...
                    location.href="${path}/frontActivity/saveActivityOderOver.do?activityId=${activity.activityId}&activityOrderId=" + activityOrderId + "&seatValues=" + encodeURI(encodeURI('<c:out escapeXml="true" value="${seatValues}"/>')) +"&eventDateTime=${activityOrder.eventDateTime}";
//                } else {
...
<form action="" name="bookOrder" id="bookOrder" method="post" >
    ...
    <input type="hidden" name="seatValues" id="seatValues" value="${seatValues}" />
                ...
                <div class="room-order-info">
                    ...
                    <script type="text/javascript">
                        function updateActivityBookInfo() {
                            location.href = "${path}/frontActivity/updateActivityBookInfo.do?eventDateTime=${activityOrder.eventDateTime}&activityId=" + '${activity.activityId}' + "&selectSeatInfo=" + '${activityOrder.orderSummary}' + "&bookCount=" + '${activityOrder.orderVotes}' + "&orderPhoneNo=" +'${activityOrder.orderPhoneNo}';
                        }
