...
<div class="ptHeadLogSear">
    <div class="jzCenter clearfix">
        <h1 class="logo fl">
            ...
            <a href="${path}/bpFrontIndex/index.do"><img src="${path}/STATIC/image/logo-sq.png" alt="" /></a></h1>
...
<div class="headNavListWc">
    <ul class="headNavList clearfix" id="headNavList">
        ...
        <li id="chuanzhouIndex"><a href="${path}/beipiaoInfo/chuanzhouIndex.do">文化资讯</a></li>
