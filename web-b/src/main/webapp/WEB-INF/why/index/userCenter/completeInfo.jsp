            ...
            <div class="register-part part1">
                <dl>
                    ...
                    <dd class="showPlaceholder">
                        <input id="newPass" type="password" class="input-text" value="" name="userPwd" maxlength="12"
                ...
                <dl>
                    <dt>确认密码</dt>
                    <dd class="showPlaceholder">
                        <input id="newPass2" type="password" class="input-text" value="" name="confirmPassword" maxlength="12"
