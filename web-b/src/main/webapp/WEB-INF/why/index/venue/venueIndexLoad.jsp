    ...
    <ul id="venue-list-ul" class="venue_ul clearfix">
        <c:forEach items="${venueList}" varStatus="s" var="c">
            ...
            <li data-id="${c.venueIconUrl}">
                ...
                <a target="_blank" href="${path}/frontVenue/venueDetail.do?venueId=${c.venueId}" class="img fl">
                    <img onload="fixImage(this, 136, 100)"/>
                </a>
                <div class="info fr">
                    <h1><a target="_blank" href="${path}/frontVenue/venueDetail.do?venueId=${c.venueId}"><c:out escapeXml="true" value="${c.venueName}"/></a></h1>
