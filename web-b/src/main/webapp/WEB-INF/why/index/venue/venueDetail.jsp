                ...
                <div class="address v_address">
                    ...
                    <div class="al_r fl">
                        ...
                        <div class="list">
                            ...
                            <c:choose>
                                <c:when test="${cmsVenue.venueHasMetro == 2 && cmsVenue.venueHasBus == 2 }"><p
                                        class="traffic"><span>地铁</span>；<span>公交</span></p></c:when>
                                <c:when test="${cmsVenue.venueHasMetro == 2 && cmsVenue.venueHasBus == 1}"><p
                                        class="traffic"><span>地铁</span></p></c:when>
                                <c:when test="${cmsVenue.venueHasMetro == 1 && cmsVenue.venueHasBus == 2}"><p
                                        class="traffic"><span>公交</span></p></c:when>
