        ...
        success: function (data) {
          if (data.status == "success") {
                ...
                $.ajax({
                  ...
                  success: function (data) {
                    if(data=="success"){
                        window.location.href="${path}/muser/setPassResult.do?m="+dataForm.userMobileNo+"&"+new Date().getTime();
                    }else{
                        addHandlerEvent();
...
<div class="content">
  ...
  <div class="find_pwd" ms-controller="setPass">
    ...
    <div class="txt">
      ...
      <input type="password" placeholder="输入原密码" ms-duplex="oldPass" maxlength="12"/>
    </div>
