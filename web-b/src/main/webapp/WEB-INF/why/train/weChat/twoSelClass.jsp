		...
		<div class="tilClass">
			...
			<div class="tabBtn borderRadiu5">
				<a href="javascript:void(0);" class="second boxSize on"
					...
					class="first boxSize" data-option='1'>第一次培训课程</a> <span></span>
			</div>
		</div>
		<div id="classOne"></div>
			...
			<div class="selCon">
				...
				<div class="signUptip borderRadiu5 clearfix">
					<div class="p">
						...
						1.2016年万人培训的第二次报名于6月7日上午9:00正式开始，培训时间为6月-9月，第三次选课定于9月初启动，具体时间请以书面通知为准。<br>
						2.每名学员的身份证号每年最多可选3天短训班1次和专题讲座6场。<br>
						3.每门课程均有报名限额，报满即止。如本次报名未成功，可在第二次和第三次报名期间继续参加选课。<br>
						4.报名是否成功，请以短信确认为准。<br> 5.报名成功后，如因故无法参加，学员须事先自行取消报名。<br>
