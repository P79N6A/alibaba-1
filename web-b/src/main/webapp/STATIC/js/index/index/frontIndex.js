        ...
        success: function (result) {
            ...
            if (data.length > 0) {
                ...
                for (var k in data) {
                    ...
                    var trueImgUrl = getIndexImgUrl(getImgUrl(imgUrl), "_300_300");
                    ...
                    str += '    <a target="_blank" href="../activity/' + data[k].activityId + '/detail.html"><img src="' + trueImgUrl + '" width="280" height="185" /></a>';
                    str += '  </div>';
                    str += '  <div class="intro">';
                    str += '    <h3><a target="_blank" href="../activity/' + data[k].activityId + '/detail.html">' + data[k].activityName + '</a></h3>';
                    ...
                    if (data[k].activityIsReservation == 2) {
                        ...
                        if (nowDateTime - maxDateTime < 0) {
                            if (availableCount > 0) {
                                ...
                                str += ' <a target="_blank" dataId=' + data[k].activityId + ' id="bookType' + data[k].sysId + '" href="../activity/' + data[k].activityId + '/detail.html" class="reserve">预 订</a>';
                            } else {
                        ...
                        if (nowDateTime - maxDateTime < 0) {
                            str += ' <a href="../activity/' + data[k].activityId + '/detail.html"  dataId=' + data[k].activityId + ' class="traffic" id="bookType' + data[k].sysId + '">直 接 前 往</a>';

                        } else {
                            str += ' <a href="../activity/' + data[k].activityId + '/detail.html"  dataId=' + data[k].activityId + ' class="traffic gray" id="bookType' + data[k].sysId + '">已 结 束</a>';
                        }
                    }
                    str += '  </div>';
                    str += '</li>';
        ...
        $.post("../frontActivity/getSubSystemTicketCount.do", $("#indexForm").serialize(), function (rsData) {
            ...
            $.each(jsonObject.tickets, function (k, v) {
                ...
                if (v == '0') {
                    ...
                    var activityUrl = "../activity/' + id+ '/detail.html";
