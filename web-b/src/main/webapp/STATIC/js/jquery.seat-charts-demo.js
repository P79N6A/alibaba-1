	...
	e.fn.seatCharts = function (t) {
			...
			return function (i) {
				...
				if(o.isWeb){
					...
					s.settings.$node.attr({
						...
						title : ""
						//title : "12121"
					}).text(s.settings.label).addClass(["seatCharts-seat", "seatCharts-cell", "available", "default"].concat(s.settings.classes, typeof n.seats[s.settings.character] == "undefined" ? [] : n.seats[s.settings.character].classes).join(" "));
				}
		...
		if (o.naming.top) {
			...
			e.each(o.naming.columns, function (t, n) {
				a.append(e("<div></div>").addClass("seatCharts-cell").text())
			})
		}
		n.append(a);
