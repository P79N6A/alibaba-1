$(function () {
	...
	$("#file").uploadify({
		...
		onUploadSuccess:function (file, data, response) {
			...
			if(initWidth<730 || initHeigth<375){
				dialogAlert("提示","请上传尺寸不小于730*375(px)的图片",function(){
				});
				//$("#isCutImg").val("N");
				return;
			}
			...
			//getAntiImg();
			//$("#isCutImg").val("N");
			var cutImageWidth=730;
			var cutImageHeigth=375;
			//var urlStr = $("#informationIconUrl").val();
...
//编辑后获取图片
function getAntiImg(){
	var imgUrl=$("#informationIconUrl").val();
