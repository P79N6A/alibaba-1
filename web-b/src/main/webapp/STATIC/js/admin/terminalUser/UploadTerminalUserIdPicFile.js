...
function getImgHtml(imgUrl){
	...
	return '<img style="width:300px; height:200px;" class="bigCheck" src="'+imgUrl+'" />';
}
function clearQueue() {
...
getImg=function(){
	...
	if(imgUrl){
		if(imgUrl.indexOf("http")!=-1){
			$("#imgHeadPrev").html("<img style='width:300px; height:200px;' source='"+imgUrl+"' class='bigCheck' src='"+imgUrl+"'>");
		}else{
