...
**/
   ...
   if(venueCrowd.trim() == ""){
        ...
        appendMsg("venueTagLabel", "请选择场馆人群标签!");
        $('#venueCrowd').focus();
        return false;
    }else{
        removeMsg("venueTagLabel");
    ...
    //if(venueLinkman.trim() == ""){
    //    removeMsg("venueLinkmanLabel");
    //    appendMsg("venueLinkmanLabel", "请填写场馆联系人!");
    //    $('#venueLinkman').focus();
    //    return false;
    //}else{
    //    removeMsg("venueLinkmanLabel");
    ...
    /********注释该段手机  2015.10.05  by  niu *************/
    /*else if(!is_mobile(venueMobile)){
        removeMsg("venueMobileLabel");
        appendMsg("venueMobileLabel","请正确填写场馆联系电话!");
        $('#venueMobile').focus();
        return false;
    }*/
...
**/
  ...
  /**  if($("#venueRoamUrl").val()!=""){
        ...
        //if(!urlReg.test($("#venueRoamUrl").val())){
...
**/
    ...
    /***验证场馆必须是数字***/
    if(venueMobile.trim() != ""){
        var venueSortValue=venueSort.trim();
        var regNumber=/^[0-9]*$/g;
        if (!regNumber.test(venueSortValue)) {
            removeMsg("venueSort");
            appendMsg("venueSort", "场馆请请填写数字!");
            $('#venueSort').focus();
            return false;
        }else{
            removeMsg("venueSort");
    ...
    //var selectCheck = checkSelected();
    //if(!selectCheck){
    //    removeMsg("selectAllLabel");
    //    appendMsg("selectAllLabel", "请勾选开放日期!");
    //    $('#selectAll').focus();
    //    return false;
    //}else{
    //    removeMsg("selectAllLabel");
...
function setDefaultVal(){
    ...
    //如果开放备注没有更改，则直接赋空值
    if(openNotice == "例如：每周天上午8:00-11:30"){
        $("#openNotice").val("");
    }
