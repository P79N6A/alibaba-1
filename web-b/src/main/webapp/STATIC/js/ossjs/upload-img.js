		...
		init: {
			...
			FilesAdded: function(up, files) {
				...
				plupload.each(files, function(file) {
					...
					$("#" + uploadDomId + " #ossfile2").append('<div name="aliFile" style="position:relative;margin-bottom:5px;margin-right:15px;max-width:130px;display:inline-block;" id="' + file.id + '"><span>' + file.name + ' (' + plupload.formatSize(file.size) + ')</span><b></b>' +
