...
{
//    NSInteger currentIndex = _mainView.contentOffset.x/_mainView.contentSize.width;
//    
//    
//    SDCollectionViewCell *cell = (SDCollectionViewCell *)[_mainView cellForItemAtIndexPath:[NSIndexPath indexPathForItem:currentIndex inSection:0]];
//    
//    //    [_mainView visibleCells][0];
//    
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_titlesGroup.count) {
        ...
        if (itemIndex > _titlesGroup.count-1) {
            itemIndex = _titlesGroup.count-1;
        }
