...
@property (weak, nonatomic) FBActivityIndicatorView *loadingView;
@end
...
- (FBActivityIndicatorView *)loadingView
{
    if (!_loadingView) {
        FBActivityIndicatorView *loadingView = [[FBActivityIndicatorView alloc] initWithImgary:CGRectMake(0, 0, 20, 20) imgary:@[@"fbload1",@"fbload2",@"fbload3",@"fbload4",@"fbload5",@"fbload6",@"fbload7",@"fbload8"]];
