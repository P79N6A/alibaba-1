...
public class ContainerAnimation {
	...
	public void alphaTranslationYAnimation(LinearLayout container) {
		...
		// 动画：DISAPPEARING
		// Removing
		ObjectAnimator animOut = ObjectAnimator.ofPropertyValuesHolder(mMyAlphaAnimation, pvhX, pvhY);
	...
	public void setAnimationLayoutListenerAdapter(AnimationLayoutListener mAnimationLayoutListenerAdapter) {
