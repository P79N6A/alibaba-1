...
import com.sun3d.ticketGdfs.Util.GetPhoneInfoUtil;
...
public class FastBlur {
	...
	public static Bitmap getScreen(Activity activity) {
		...
		if (GetPhoneInfoUtil.getManufacturers().equals("Meizu")) {
			FastBlurBitmap = Bitmap.createBitmap(view.getDrawingCache(), 0, statusBarHeights,
					MyApplication.getWindowWidth(), MyApplication.getWindowHeight()
							- statusBarHeights - 500);
