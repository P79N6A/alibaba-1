 ...
 * 2015-06-03
 * */
public abstract class SXReflectionUtils {
	  ...
	  /**
	    ...
	    public static <T> void copyProperties(T fromobj, T toobj,
	        ...
	        for (String filename : fieldspec) {
	            Object val = SXReflectionUtils.invokeGetterMethod(fromobj, filename);
	            SXReflectionUtils.invokeSetterMethod(toobj, filename, val);
	        }
	    ...
	    private static Object handleValueType(Object obj, String propertyName,
	        ...
	        if (returnType == Boolean.class) {
	            ...
	            try {
	                value = SimpleDateFormatFactory.getInstance(DateUtil.YYYY_MM_DD_HH_MM_SS).parse(value.toString());
