...
//      return decoder.decodeBuffer(value);  
    ...
    public static void main(String[] args) throws IOException
    {
    	String parame = "com.culturecloud.service.rs.demo."
				+ "DemoResource.getDemo.{\"source\" : \"ios\"}DemoResource.getDemo.{\"source\" : \"ios\"}DemoResource.getDemo.{\"source\" : \"ios\"}DemoResource.getDemo.{\"source\" : \"ios\"}DemoResource.getDemo.{\"source\" : \"ios\"}DemoResource.getDemo.{\"source\" : \"ios\"}DemoResource.getDemo.{\"source\" : \"ios\"}DemoResource.getDemo.{\"source\" : \"ios\"}DemoResource.getDemo.{\"source\" : \"ios\"}DemoResource.getDemo.{\"source\" : \"ios\"}DemoResource.getDemo.{\"source\" : \"ios\"}DemoResource.getDemo.{\"source\" : \"ios\"}DemoResource.getDemo.{\"source\" : \"ios\"}DemoResource.getDemo.{\"source\" : \"ios\"}";
		System.out.println("压缩前：" + parame);
		
		
		String parames = bytesToBase64(parame.getBytes());
		System.out.println("压缩后:" + parames);
		System.out.println(parames.length());
		byte[] a=base64ToBytes(parames);
		//byte[] parames = base64ToBytes(parames);
