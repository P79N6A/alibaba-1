...
/*            Runnable runner = new Runnable() {
    ...
    @Override
    public List<CmsTag> selectAllTrainTag(String tagType) {
        Map<String,Object> map = new HashMap<>();
        map.put("dictCode",tagType);
        List<SysDict> dict = dictMapper.querySysDictByByMap(map);
        return cmsTagMapper.selectAllTrainTag(dict.get(0).getDictId());
    }
}
