...
public class BpInfoTagServcieImpl implements BpInfoTagServcie{
	...
	public List<BpInfoTag> queryParentTag() {
		return bpInfoTagMapper.queryParentTagsByCode(null);
	}

	@Override
	public List<BpInfoTag> queryParentTag(String module) {
		return bpInfoTagMapper.queryParentTagsByCode(module);
	}
