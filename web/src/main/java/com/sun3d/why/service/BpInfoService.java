...
public interface BpInfoService {
	 ...
	 * @return
	 */
	List<BpInfo> wechatQueryInfoList2(String parentTagId, PaginationApp pageApp);
    ...
    List<BpInfo> queryOtherInfoList(BpInfo bpInfo, Pagination page);

    List<BpInfo> loadwxazList(String beipiaoinfoTag, String module, PaginationApp pageApp);
}
