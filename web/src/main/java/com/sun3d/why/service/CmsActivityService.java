...
public interface CmsActivityService {
    ...
    /**
     * 查询首页文化日历
     * @param TIME （例：20190505）
     * @return
     */
    List<CmsActivity> queryCalendarAdvert(String TIME);

    void appActivitySetRedis();
     ...
     * @return 活动列表信息
     */
    List<CmsActivity> queryCmsActivityByAdminCondition(CmsActivity activity, Pagination page, SysUser sysUser);
    ...
    String recommendActivity(String id, SysUser user, String platform);
    ...
    boolean  backActivityStatus(String id);

    boolean  backActivityAPI(String id, String sysNo);
    /**
     * 查询最新发布活动
     * @param activity 活动对象
     * @param page 分页对象
     ...
     * @return
     */
    List queryActivitySeatInfoById(String activityId);
     ...
     * @return
     */
    List<CmsActivity> queryActivityListByCity(String areaCode, String[] activityIds, String activityName, CmsActivity cmsActivity, Pagination page);
     ...
     * @param pageApp
     */
    List<CmsActivity> queryAppCountByActivity(String tagId, String dictCode, String date, PaginationApp pageApp);
     ...
     * @return
     */
    List<Map> queryActivityLabelById(String activityId);
     ...
     * @return
     */
    List<Map> queryExistArea(String activityState);
     ...
     * @throws Exception
     */
    List queryActivityListLoad(CmsActivity activity, String areaCode,
     ...
     * @throws Exception
     */
    List queryActivityListCollectNumLoad(CmsActivity activity, Pagination page) throws Exception;
     ...
     * @throws Exception
     */
    List queryActivityListTicketLoad(CmsActivity activity,String machineCode, Pagination page) throws Exception;
     ...
     * @return
     */
    int queryActivityListLoadCount(Map map);

    /**
     * 查询需要统计的活动数据
     */
    List<Map> queryActivityStatistic(Map map, int type);
  ...
  //  String frontSetRedisTicketCount(String activityId) throws ParseException;
     ...
     * @return
     */
    String setRightToRedisAndDataBase(String activityId, String eventId) throws Exception;
     ...
     * @return
     */
    Map queryActivitySeatInfo(String activityId, String eventDateTime) throws Exception;
     ...
     * @return
     */
    Map queryFrontDetailInfo(String activityId) throws Exception;
...
/*
     ...
     * @return
     */
    List<CmsActivity> queryIndexActivityByCondition(CmsActivity activity, Pagination page, String isWeekend, String chooseType, String sortType, String bookType, CmsTerminalUser terminalUser);
	...
	List<CmsActivity> pcnewActivity(String activityType,int num);

	List<CmsActivity> getPctuijianActivity(List<String> ids);

    List<CmsActivity> queryCmsActivityUnion(String id,Integer count);

    List<CmsActivity> queryCmsActivityUnionPage(String id,Integer pageIndex);

    List<CmsActivity> queryCmsActivityByMember(CmsMemberBO bo);

	List<CmsActivity> queryRelatedActivity(CmsActivity cmsActivity, boolean excludeFlag);

	int queryRelatedActivityCount(CmsActivity cmsActivity, boolean excludeFlag);
}
