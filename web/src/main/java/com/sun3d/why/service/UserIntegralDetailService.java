...
public interface UserIntegralDetailService {
	 ...
	 * @return
	 */
	int liveLikeAddIntegral(String userId,String liveActivityId);
	 ...
	 * @return
	 */
	int liveCommentAddIntegral(CcpLiveMessage message);
	 ...
	 * @return
	 */
	String updateIntegralByVo(UserIntegralDetail vo);
}
