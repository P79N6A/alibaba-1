...
public class VolunteerActivityServiceImpl implements VolunteerActivityService {
    ...
    @Override
    public List<VolunteerActivity> queryVolunteerActivityByRelationJson(Map<String, Object> paramMap) {

        return volunteerActivityMapper.queryVolunteerActivityByRelationJson(paramMap);
    }
