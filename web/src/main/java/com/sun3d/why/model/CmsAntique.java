...
public class CmsAntique extends Pagination implements Serializable{
    ...
    public String getAntiqueVenueId() {
        return antiqueVenueId;
    }

    public void setAntiqueVenueId(String antiqueVenueId) {
        this.antiqueVenueId = antiqueVenueId == null ? null : antiqueVenueId.trim();
    }
