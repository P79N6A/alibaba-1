...
public interface VenueAppService {
   ...
   * @return
   */
  String queryAppVenueList(PaginationApp pageApp, String venueArea, String venueMood, String venueType, String sortType, String venueIsReserve,String tagSubId, String lon, String lat);
   ...
   * @return
   */
  String queryAppCmsVenueList(PaginationApp pageApp, String venueType, String venueArea, String venueName,String tagSubId);
   ...
   * @param userId
   */
  String queryHotVenueInfo(String venueId, String userId);
   ...
   * @return
   */
  String queryVenueCountInfo(String venueId);
  
  String queryVenueByType(String venueType, String venueName);
}
