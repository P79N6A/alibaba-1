...
public class VenueAppController {
    ...
    public String appCmsVenueList(HttpServletResponse response,String venueType, String venueArea, String venueName,String tagSubId, String pageIndex, String pageNum, PaginationApp pageApp) throws Exception {
        pageApp.setFirstResult(Integer.valueOf(pageIndex));
        pageApp.setRows(Integer.valueOf(pageNum));
        String json="";
        try {
    ...
    /**
     * why3.5.4 app场馆在线活动及活动室数
     * @param response
     * @param sortType
     * @throws Exception
     */
    @RequestMapping(value = "/appVenueCountInfo")
    public void appVenueCountInfo(HttpServletResponse response, String venueId) throws Exception{
		String json = "";
		try {
