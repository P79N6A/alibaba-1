...
public interface ActivityAppOrderService {
   ...
   public String queryAppPastOrdersByUserId(String userId, PaginationApp pageApp);
     ...
     * @return
     */
    public  String takeAppActivityValidateCode(String validateCode,String seats,int i,String machineCode) throws Exception;
    ...
    CmsActivityOrder queryValidateCode(String orderValidateCode);
}
