...
public interface BpInfoMapper {
	...
	/**
	 * 根据标父签编码查找资讯列表
	 * @param queryMap（父标签编码+分页信息）
	 * @return
	 */
	List<BpInfo> queryBpInfoListByParentId(Map<String, Object> queryMap);
    ...
    Integer queryInfoCountByMap(Map<String,Object> queryMap);

	List<BpInfo> queryInfoListByMap(Map<String,Object> queryMap);

    List<BpInfo> querywxBpInfoListByCode(Map<String,Object> queryMap);
}
