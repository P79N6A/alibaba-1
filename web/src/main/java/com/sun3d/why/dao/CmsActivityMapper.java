...
public interface CmsActivityMapper {
    ...
    List<CmsActivity> queryCalendarAdvert(Map map);
    ...
    @Select("SELECT a.ACTIVITY_ID activityId,a.ACTIVITY_NAME activityName, a.ACTIVITY_CREATE_TIME activityCreateTime, a.ACTIVITY_ICON_URL activityIconUrl,a.ACTIVITY_ADDRESS activityAddress  FROM cms_member m JOIN cms_member_relation r ON m.id = r.member_id  AND r.relation_type = 1 JOIN cms_activity_venue_relevance v ON r.relation_id = v.VENUE_ID JOIN cms_activity a ON v.ACTIVITY_ID = a.ACTIVITY_ID WHERE r.member_id = #{0} and a.ACTIVITY_IS_DEL=1 and a.ACTIVITY_STATE=6 ORDER BY a.ACTIVITY_CREATE_TIME DESC LIMIT #{1},6")
...
//    public List<Map> queryIndexListCollectViewNum(Map map);
    ...
    public List queryActivityListTicketLoad(Map map);
    
    public int queryActivityListTicketLoadCount(Map map);
    ...
    /**
     * why3.5 app根据展馆id获取相关(历史)活动列表
     * @param map
     * @return
     */
    List<CmsActivity> queryHisActivityListByVenueId(Map<String, Object> map);
    ...
    List<CmsActivity> queryAppCmsActivityListByConditionAll(Map<String, Object> map);
    ...
    int queryAppCmsActivityListCountAll(Map<String, Object> map);
     ...
     * @return
     */
    List<CmsActivity> queryActivityByCreateTimeDesc(Map<String, Object> map);
     ...
     * @return
     */
    List<CmsActivity> queryCultureCalendarList(Map<String, Object> map);
     ...
     * @return
     */
    int queryCultureCalendarActivityCount(Map<String, Object> map);
     ...
     * @return
     */
    List<CmsActivity> queryMyCultureCalendarList(Map<String, Object> map);

	List<CmsActivity> queryPcnewActivity(Map map);

	List<CmsActivity> queryPctuijianActivity(List<String> ids);
	
	List<CmsActivity> queryCultureMapActivityListById(Map<String, Object> map);

    List<CmsActivity> queryCmsActivityByMember(CmsMemberBO bo);

    Integer queryCountActivityByCondition(Map map);

	List<CmsActivity> queryRelatedActivity(Map<String, Object> map);

	int queryRelatedActivityCount(Map<String, Object> map);
