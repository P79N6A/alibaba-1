jQuery(function() {
	...
	uploader.on('fileQueued', function(file) {
		$("#upPhoto").attr("src","../STATIC/wxStatic/image/beautyCity/loading.gif");
	});
	...
	uploader.on('uploadSuccess', function(file, response) {		
	    ...
	    if(response.status==0){
    		...
    		$("#beautycityImgUrl").val(imgUrlAli);
	    }else{
	    	$("#upPhoto").attr("src","../STATIC/wxStatic/image/beautyCity/upPhoto.png");
