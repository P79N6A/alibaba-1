...
<div id="download_list">
    ...
    <ul class="table_download clearfix">
        <li>
            <p>1.文化安康云平台运营补充规范（全文）</p>
            <a href="http://img1.wenhuayun.cn/admin/文化安康云平台运营补充规范.doc" target="_blank">下载文件</a>
        </li>
        <li>
            <p>2.文化安康云宣传物料汇总表</p>
            <a href="http://img1.wenhuayun.cn/admin/文化安康云宣传物料汇总表.doc" target="_blank">下载文件</a>
        </li>
        <li>
            <p>3.文化安康云资源汇总表</p>
            <a href="http://img1.wenhuayun.cn/admin/文化安康云资源汇总表.doc" class="d_file" target="_blank">下载文件</a>
        </li>
    </ul>
    <!--third end-->
    <!--four start-->
