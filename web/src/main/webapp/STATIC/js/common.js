...
function getImgUrl(imgurl) {
    ...
    var staticServerUrl = $('#staticImgServerUrl').val();
    if(staticServerUrl == null || staticServerUrl == '') {
        // staticServerUrl = "http://127.0.0.1:8080/static/" ;
        staticServerUrl = "http://119.23.14.134:12006/";
    }
...
function getChinaServerUrl() {
    // return "http://localhost:8081/why/";
