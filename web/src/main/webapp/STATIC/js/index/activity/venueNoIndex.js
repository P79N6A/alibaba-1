...
function doQuery(venueName,typeData,crowdData){
    ...
    var type = $("#type").val();
    $("#activity_content").load("../frontActivity/venueNoIndexLoad.do",{venueName:venueName,activityName:activityName,type:type,countPage:countPage,page:reqPage},function(){
        getVenueListPics();
        //得到喜欢搜藏的人数
        $("#loadListIdDiv").find("span[class=like]").each(function (index, item) {
...
function getVenueListPics(){
    //请求页面下方团体所有图片
    $("#loadListIdDiv li").each(function (index, item) {
