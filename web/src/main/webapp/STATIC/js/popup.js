    ...
    //默认参数
    var PARAMS;
    var DEFAULTPARAMS = { Title: "素材家园", Content: "", Width: 400, Height: 300,ensure:"", URL: "", ConfirmFun: new Object, CancelFun: new Object };
    var ContentWidth = 0;
    var ContentHeight = 0;
    $.DialogBySHF = {
        //弹出提示框
    ...
    function Init(params) {
        ...
        ContentHeight = PARAMS.Height - 73;
    };    
    //显示弹出框
    function Show(params, caller) {
        ...
        if (caller == "Dialog") {
            ...
            if (caller == "Confirm") {
                Content.push("                    <input type=\"button\" id=\"btnDialogBySHFCancel\" value=\"取 消\" />");
            }
             Content.push("                    <input type=\"button\" id=\"btnDialogBySHFConfirm\" value="+PARAMS.ensure+" />");
            Content.push("                </td>");
            Content.push("            </tr>");
            Content.push("        </table>");
        }
        ...
        (function(){
             //举报原因选中
           $(".reportreasons").find("input[type='checkbox']").change(function(){
               if($(this).prop("checked")){
                   $(this).parents("label").append("<i></i>")
               }else{
                   $(this).parents("label").find("i").remove()
               }
           }) 
        })();    
    }
