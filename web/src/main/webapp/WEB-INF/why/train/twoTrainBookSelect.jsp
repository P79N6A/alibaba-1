    ...
    <div  class="register-content" style="width:100%">
       ...
       <div class="steps steps-room">
        ...
        <div class="tabBtn borderRadiu5">
             <a href="javascript:void(0);" class="third boxSize" data-option='3'><i>第三次培训课程</i></a>
             <a href="javascript:void(0);" class="second boxSize on" data-option='2'><i>第二次培训课程</i></a>
        ...
        <div class="room-part1 room-part2">
          ...
          <div class="book_inner">
            <div class="notes-content">
              ...
              <p>1.2016年万人培训的第二次报名于6月7日上午9:00正式开始，培训时间为6月-9月，第三次选课定于9月初启动，具体时间请以书面通知为准。</p>
