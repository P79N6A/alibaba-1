...
<%@include file="../index/index_top.jsp"%>
    ...
    <div class="register-content">
        ...
        <div class="tabBtn borderRadiu5">
             <a href="javascript:void(0);" class="third boxSize on" data-option='3'><i>第三次培训课程</i></a>
             <a href="javascript:void(0);" class="second boxSize" data-option='2'><i>第二次培训课程</i></a>
             <a href="javascript:void(0);" class="first boxSize" data-option='1'><i>第一次培训课程</i></a>
             <span></span>
         </div>
         <div id="classOne"></div>
        ...
        <div class="room-part1 room-part2">
              ...
              <div class="train_sel_con">
                  <table class="trains_select" width="100%" style="margin-top: 0;">
                    ...
                    <input id="TY${course.courseId}" type="hidden" name="courseType"  disabled="disabled" value="${course.courseType}" class="rp_noinput"/>
                     <tr>
                       <!-- 日期判断 时间控制  到2016-09-07 09:00 开放 --> 
          ...
          <div class="book_inner">
            <div class="notes-content">
              ...
              <p>1.2016年万人培训的第三次报名于9月7日上午9:00正式开始，培训时间为10月-12月。</p>
            ...
            <input type="button"  value="上一步" class="btn-submit book-submit book_return" onclick="location.href='${path}/train/toBookTrain.do'">
               ...
               <c:if test="${registerStatus=='open'}">  
                ...
                <c:if test="${registerStatus=='close'}">  
                  <input id="subOrder" type="button"  value="提交" class="btn-submit book-submit"  disabled onclick="alertForbbiden();" style="background:url('${path}/STATIC/train/image/register-icongray.png') no-repeat center center">
               </c:if>
...
$(".tabBtn").on('click','a',function(){
	 ...
	 if(dataOption=='3'){//第二次培训课程
		 $("#vform").show();
	     $("#classOne").html('');
	 }else if(dataOption=='2'){//第一次培训课程
 		 $("#vform").hide();
		 var links='${path}/train/toOrder.do?type=2';
		 changeClass(links)
	 }
	 else{//第一次培训课程
		 $("#vform").hide();
		 var links='${path}/train/toOrder.do?type=1';
		 changeClass(links)
	 }
})   
