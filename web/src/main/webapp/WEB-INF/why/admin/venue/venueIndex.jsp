...
<head>
    ...
    <script type="text/javascript">
        ...
        function preDeleteVenue(veuneId) {
      	...
      	//场馆推广
        function preExtension(venueId){
            $.DialogBySHF.Dialog({
                Width: 560,
                Height: 470,
                URL: '../venue/preExtension.do?venueId=' + venueId
            });
        }
    </script>
</head>
    ...
    <div class="main-content">
        <table width="100%">
            ...
            <c:forEach items="${list}" var="c" varStatus="s">
                <tr>
                    <td>${s.index+1}</td>
                    <td class="title"><a href="${path}/frontVenue/venueDetail.do?venueId=${c.venueId}"
                    ...
                    <td>
                        ...
                        | <a href="${path}/video/videoIndex.do?referId=${c.venueId}&videoType=2&referName=${c.venueName }" target="main">视频管理</a>
                        <%if (venueExtensionButton) {%>
	                        | <a href="javascript:;" onclick="preExtension('${c.venueId}');">场馆推广</a>
	                    <%}%>
                    </td>
                </tr>
            </c:forEach>
