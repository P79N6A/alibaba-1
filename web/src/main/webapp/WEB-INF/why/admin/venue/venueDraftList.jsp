    ...
    <script type="text/javascript">
        ...
        * 发布场馆
        ...
        function publishVenue(venueId){
            var html = "您确定要将发布吗？";
            dialogConfirm("提示", html, function(){
                $.post("${path}/venue/publishVenue.do",{"venueId":venueId}, function(data) {
                    if (data!=null && data=='success') {
                        window.location.href="${path}/venue/venueDraftList.do";
                    }
                });
...
<div class="site">
    <em>您现在所在的位置：</em>场馆管理 &gt; 场馆信息管理&gt; 场馆草稿箱
</div>
<form id="venueIndexForm" method="post" action="${path}/venue/venueDraftList.do">
<div class="search">
        ...
        <c:forEach items="${list}" var="c" varStatus="s">
            <tr>
                ...
                <td class="operate">
                    ...
                    <%
                        if(publishVenueDrafButton) {
                    %>
                        <a href="javascript:;" onclick="publishVenue('${c.venueId}')">发布</a>
                    <%
                        }
                    %>
