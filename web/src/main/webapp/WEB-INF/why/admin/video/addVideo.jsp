    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $(".start-btn").on("click", function(){
                WdatePicker({el:'dateHidden',dateFmt:'yyyy-MM-dd',doubleCalendar:true,minDate:'', oncleared:function() {$("#videoCreateTime").val("");},position:{left:-224,top:8},isShowClear:true,isShowOK:true,isShowToday:false,onpicked:pickedStartFunc})
            })
        });
        ...
        seajs.use(['jquery'], function ($) {
            $(function () {
                ...
                $(".btn-save").on("click", function(){
                    ...
                    $.post("${path}/video/addVideo.do" , $("#addVideo").serialize(),
                            function(result) {
...
<div class="main-publish tag-add">
    <table width="100%" class="form-table">
        <tr>
            ...
            <td class="td-input">
                <input type="text" id="videoTitle" name="videoTitle"
                       value="${videoTitle}" class="input-text w220"/>
            </td>
        </tr>
        <tr>
            <td width="28%" class="td-title"><span class="red">*</span>发布人：</td>
            <td class="td-input">
        ...
        <tr>
            <td width="100" class="td-title"><span class="red">*</span>发布时间：</td>
            <td class="td-time"  id="videoCreateTimeLabel">
                <div class="start w240">
                    <input type="hidden" id="dateHidden"/>
                    <input type="text" id="videoCreateTime" name="videoCreateTime" value="" readonly/>
                    <i class=" start-btn"></i>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td class="td-input" >
                <input type="text" id="videoLink" name="videoLink"
                       value="${videoLink}" class="input-text w220"/>
            </td>
        </tr>
        <tr>
            ...
            <td class="td-upload" id="videoImgUrlLabel">
                <table>
                    <tr>
                        <td>
                            <input type="hidden"  name="videoImgUrl" id="videoImgUrl" value="${videoImgUrl}">
