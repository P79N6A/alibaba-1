...
<head>
    ...
    <script type="text/javascript">
                ...
                if ($(this).is(':checked')) {
                    ...
                    $(this).next("select").change(function () {
                        if ($(this).parentsUntil("li").find(".ckselect").val() == 1 || $(this).parentsUntil("li").find(".ckselect").val() == 3) {
                            $(this).parentsUntil("li").find(".line-2").removeClass("checkedoff").html("关键字:").css("margin-left", "-100px");
        ...
        $(function () {
            ...
            uploadFun(type, userCounty, sessionId, "file0");
                ...
                $.post("${path}/advertRecommend/addAdvert.do", $("#advertForm").serialize(),
                        ...
                        function (data) {
                            if (data != null && data == 'success') {
                                ...
                                dialogAlert("提示", "请将信息填写完整！", function () {
                                });
                            }
                        });
            });
...
<body>
<div class="site">
    <em>您现在所在的位置：</em>推荐管理 &gt; App端端推荐 &gt; 广告位推荐 &gt; 添加广告位
</div>
<form id="advertForm" method="post">
    ...
    <div class="main">
                    ...
                    <td class="td-tag " style="width:100%">
                        <dl>
                            <input id="advPostion" name="advPostion" style="position: absolute; left: -9999px;"
                                   type="hidden" value=""/>
                            <dd id="activityTypeLabel" style="clear:both;">
                            </dd>
                        </dl>
                    </td>
                </tr>
            ...
            <div class="content-p1-right1">
                ...
                <ul>
                    <li>
                        ...
                        <div class="line">
                            <p class="line-1">
                                <input class="checkbox1" type="checkbox" name="advBannerFIsLink" value="1"/>外链
                                <input class="checkbox2" type="checkbox" name="advBannerFIsLink" value="0"/>内链
                                <select class="ckselect checkedoff" name="advBannerFLinkType">
                                    <option value="">请选择..</option>
                                    <option value="0">活动list</option>
                                    <option value="1">活动详细页</option>
                                    <option value="2">场馆list</option>
                                    <option value="3">场馆详细页</option>
                                </select>
                            </p>
                           </div>
                        <div style="clear: both;"></div>
                        <div style="margin-left:0px;" id="advLinka" name="advLinka"><label class="line-2"  style="margin-right:10px;">Url/关键词：</label><input
                                    type="text" name="advBannerFUrl" id="advBannerFUrl" value="" style="width: 280px; height: 30px; border:1px solid #ACB4C3;border-radius: 5px;-webkit-border-radius:5px;-moz-border-radius:5px; outline: none;"></div>
                    ...
                    <li>
                        ...
                        <div class="line">
                            <p class="line-1">
                                <input class="checkbox1" type="checkbox" name="advBannerSIsLink" value="1"/>外链
                                <input class="checkbox2" type="checkbox" name="advBannerSIsLink" value="0"/>内链
                        ...
                        <div style="margin-left:0px;" id="advLinkb" name="advLinkb"><label class="line-2"  style="margin-right:10px;">Url/关键词：</label><input
                                type="text" name="advBannerSUrl" id="advBannerSUrl" value="" style="width: 280px; height: 30px; border:1px solid #ACB4C3;border-radius: 5px;-webkit-border-radius:5px;-moz-border-radius:5px; outline: none;"></div>
                    ...
                    <li>
                        ...
                        <div class="line">
                            <p class="line-1">
                                <input class="checkbox1" type="checkbox" name="advBannerLIsLink" value="1"/>外链
                                <input class="checkbox2" type="checkbox" name="advBannerL IsLink" value="0"/>内链
                        ...
                        <div style="margin-left:0px;" id="advLinkc" name="advLinkc"><label class="line-2"  style="margin-right:10px;">Url/关键词：</label><input
                                type="text" name="advBannerLUrl" id="advBannerLUrl" value="" style="width: 280px; height: 30px; border:1px solid #ACB4C3;border-radius: 5px;-webkit-border-radius:5px;-moz-border-radius:5px; outline: none;"></div>
                    </li>
                </ul>
            </div>
            <div style="clear: both;"></div>
        ...
        <div class="content-p2">
            <p class="tit"><input type="checkbox" name="isContainActivtiyAdv" value="1"/>新增广告位(每隔3场活动出现一次)</p>
            <div class="p2-upload">
                    ...
                    <li>
                        <div>
                            <div class="p2-upload-left" style="position:relative;">
                                ...
                                <div id="imgHeadPrevfile0" style="position:absolute;top:0px;left:0px;"></div>
                                <input type="hidden" name="dataList[0].advertImgUrl" id="advertImgUrl0"
                                       value="">
                            </div>
                            <div class="p2-upload-right">
                                <p class="p2-line1">B1:<span>URL:</span><input name="dataList[0].advertUrl" type="text"
                                                                               class="p2-line1-1 w200"><input
                                        name="dataList[0].advertSort" type="text" class="p2-line1-2"></p>
        ...
        $(document).ready(function () {
            $(".add-upload").click(function () {
                ...
                $(".content-p2 ul").append(
                        "<li>" +
                        "<div>" +
                        "<div class='p2-upload-left' style='position:relative;'><input type='file' name='file" + count + "' id='file" + count + "'><div id='imgHeadPrevfile" + count + "' style='position:absolute;top:0px;left:0px;'></div><input type='hidden' name='dataList[" + count + "].advertImgUrl' id='imgUrlfile" + count + "'value='admin/45/201604/Img/Img0d0319479ca942828208531a25e8d1ca.jpg'></div>" +
                        "<div class='p2-upload-right'>" +
                        "<p class='p2-line1'>" +
