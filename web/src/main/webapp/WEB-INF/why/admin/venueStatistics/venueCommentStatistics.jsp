...
<head>
  ...
  <script type="text/javascript">
    ...
    function exportExcel() {
      location.href = "${path}/venueStatistics/exportVenueByMessageExcel.do?" + $("#comment").serialize();
    }
    // 分页
    $(function(){
...
<div class="site">
  <em>您现在所在的位置：</em>数据管理 &gt; 场馆数据统计 &gt; 场馆评论报表
</div>
...
<div class="data-content">
    ...
    <div class="form-table">
      ...
      <div class="td-time" style="margin-top: 0px;">
        <div class="start w240" style="margin-left: 8px;">
          ...
          <input type="text" id="activityStartTime" name="activityStartTime" value="${venueStatistics.activityStartTime}" readonly/>
        ...
        <div class="end w240">
          ...
          <input type="text" id="activityEndTime" name="activityEndTime" value="${venueStatistics.activityEndTime}" readonly/>
  ...
  <div>&nbsp;&nbsp;&nbsp;&nbsp;
    <c:if test="${not empty venueStatistics.activityStartTime}">
      ${venueStatistics.activityStartTime}——${venueStatistics.activityEndTime}内，
    </c:if>
  ...
  <div class="table-cont"  >
    <table width="100%" class="tab-data" id="Area_Info">
      ...
      <c:forEach items="${list}" var="c" varStatus="s">
        <tr>
          <td width="80%"><a href="${path}/frontVenue/venueDetail.do?venueId=${c.venueId}" target="_blank" style="float: left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${c.venueName}</a></td>
          <td width="20%" ><a href="${path}/activityStatistics/activityMessage.do?activityId=${c.venueId}" target="Frame2">${c.numMessage}</a></td>
        </tr>
      </c:forEach>
      </tbody>
