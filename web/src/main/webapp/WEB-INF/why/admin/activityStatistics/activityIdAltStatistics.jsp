...
<div class="site-title">上海市</div>
<table width="100%" class=" main-publish form-table" >
    <tr>
        <td width="100" class="td-title"><span class="red">*</span>活动名称：</td>
        <td class="td-input" ><input type="text" ng-model="activityName"  class="input-text w410" maxlength="20"/></td>
...
<script type="text/javascript"
        src="${path}/STATIC/js/admin/statistics/alterIdStatistics.js?version=11tyu1"></script>
