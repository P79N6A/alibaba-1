...
<html>
<head>
<title>添加活动模板--文化云</title>
<%@include file="/WEB-INF/why/common/pageFrame.jsp"%>
<%@include file="/WEB-INF/why/common/limit.jsp"%>
<script type="text/javascript" >
	function submitData(){
		$(".btn-save").attr("onclick", "");
		$.post("${path}/activityTemplate/activityTemplateAdd.do", $("#activityTemplateForm").serialize(),
			function(data) {
      ...
      <div style="border-bottom: 1px dashed #d9d9d9;padding:30px 0px;">
          ...
          <tr>
          	...
          	<td class="td-input" id="templNameLabel">
          		<input type="text" id="templName" name="templName" class="input-text w510"  maxlength="20"/>
          	</td>
          </tr>
        </table>
      </div>
              	...
              	<td style="line-height: 30px;">
	              	<div class="main-publish tag-add clearfix">
					   <div id="template_list">
					     ...
					     <input type="hidden" id="selected_mode" name="functions"/>
