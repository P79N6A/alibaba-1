...
<head>
	...
	<div class="picOneListWc">
		<ul class="picOneList">
			
			<c:forEach items="${info.detailList }" var="detail">
				
				<c:set var="detailUrl" value="${ fn:split(detail.detailImage,',') }"></c:set>
				
				<c:choose>
					<c:when test="${ fn:length(detailUrl)==0 }">
						<li>
							<div class="wz">${detail.detailContent }</div>
							<div class="picSet picSet_1 clearfix">
							</div>
							<div class="dh"></div>
						</li>		
					</c:when>
					<c:when test="${ fn:length(detailUrl)==1 }">
						<li>
							<div class="wz">${detail.detailContent }</div>
								<div class="picSet picSet_1 clearfix">
								<c:if test="${!empty detailUrl[0] }"><div class="item"><img src="${detailUrl[0] }@700w"></div></c:if>
								</div>
							<div class="dh"></div>
						</li>		
					</c:when>
					<c:when test="${ fn:length(detailUrl)==2 }">
						<li>
							<div class="wz">${detail.detailContent }</div>
							<div class="picSet picSet_2 clearfix">
								<div class="item"><img src="${detailUrl[0] }@340w"></div>
								<div class="item"><img src="${detailUrl[1] }@340w"></div>
							</div>
							<div class="dh"></div>
						</li>		
					</c:when>
					<c:when test="${ fn:length(detailUrl)==3 }">
						<li>
							<div class="wz">${detail.detailContent }</div>
							<div class="picSet picSet_3 clearfix">
								<div class="item"><img src="${detailUrl[0] }@220w"></div>
								<div class="item"><img src="${detailUrl[1] }@220w"></div>
								<div class="item"><img src="${detailUrl[2] }@220w"></div>
							</div>
							<div class="dh"></div>
						</li>		
					</c:when>
					<c:when test="${ fn:length(detailUrl)==4 }">
						<li>
							<div class="wz">${detail.detailContent }</div>
							<div class="picSet picSet_2 clearfix">
								<div class="item"><img src="${detailUrl[0] }@340w"></div>
								<div class="item"><img src="${detailUrl[1] }@340w"></div>
								<div class="item"><img src="${detailUrl[2] }@340w"></div>
								<div class="item"><img src="${detailUrl[3] }@340w"></div>
							</div>
							<div class="dh"></div>
						</li>		
					</c:when>
					<c:when test="${ fn:length(detailUrl)==5 }">
						<li>
							<div class="wz">${detail.detailContent }</div>
							<div class="picSet picSet_2 clearfix">
								<div class="item"><img src="${detailUrl[0] }@340w"></div>
							...
							<div class="picSet picSet_3 clearfix">
								<div class="item"><img src="${detailUrl[2] }@220w"></div>
								<div class="item"><img src="${detailUrl[3] }@220w"></div>
								<div class="item"><img src="${detailUrl[4] }@220w"></div>
							</div>
							<div class="dh"></div>
						</li>		
					</c:when>
					<c:when test="${ fn:length(detailUrl)==6 }">
						<li>
							<div class="wz">${detail.detailContent }</div>
							...
							<div class="picSet picSet_3 clearfix">
								...
								<div class="item"><img src="${detailUrl[3] }@220w"></div>
								<div class="item"><img src="${detailUrl[4] }@220w"></div>
								<div class="item"><img src="${detailUrl[5] }@220w"></div>
							</div>
							<div class="dh"></div>
						</li>		
					</c:when>
					<c:when test="${ fn:length(detailUrl)==7 }">
						<li>
							<div class="wz">${detail.detailContent }</div>
							<div class="picSet picSet_1 clearfix">
								<div class="item"><img src="${detailUrl[0] }@700w"></div>
							</div>
							<div class="picSet picSet_3 clearfix">
								<div class="item"><img src="${detailUrl[1] }@220w"></div>
								<div class="item"><img src="${detailUrl[2] }@220w"></div>
								...
								<div class="item"><img src="${detailUrl[4] }@220w"></div>
								<div class="item"><img src="${detailUrl[5] }@220w"></div>
								<div class="item"><img src="${detailUrl[6] }@220w"></div>
							</div>
							<div class="dh"></div>
						</li>		
					</c:when>
					<c:when test="${ fn:length(detailUrl)==8 }">
						<li>
							<div class="wz">${detail.detailContent }</div>
							<div class="picSet picSet_2 clearfix">
								<div class="item"><img src="${detailUrl[0] }@340w"></div>
							...
							<div class="picSet picSet_3 clearfix">
								...
								<div class="item"><img src="${detailUrl[5] }@220w"></div>
								<div class="item"><img src="${detailUrl[6] }@220w"></div>
								<div class="item"><img src="${detailUrl[7] }@220w"></div>
							</div>
							<div class="dh"></div>
						</li>		
					</c:when>
					 ...
					 <li>
							...
							<div class="picSet picSet_3 clearfix">
								...
								<div class="item"><img src="${detailUrl[6] }@220w"></div>
								<div class="item"><img src="${detailUrl[7] }@220w"></div>
								<div class="item"><img src="${detailUrl[8] }@220w"></div>
							</div>
							<div class="dh"></div>
						</li>		
                     </c:otherwise>
