...
<head>
	...
	<div class="background-fx" style="position: fixed;top: 0px;left: 0px;width: 100%;height: 100%;display: none;z-index:15;">
			<img src="${path}/STATIC/wxStatic/image/fx-bg.png" style="width: 100%;height: 100%;" />
		</div>
		
		
	<div class="picTwoSwiper swiper-container">
	    <div class="swiper-wrapper">
	<c:forEach items="${info.detailList }" var="detail">
		 <div class="swiper-slide">
		 
		 	<c:choose>
		 		<c:when test="${not empty detail.detailImageLink }">
		 			<div class="pic"><a href="${detail.detailImageLink  }"><img src="${detail.detailImage }@750W"></a></div>
		 		</c:when>
		 		<c:otherwise>
		 			<div class="pic"><img src="${detail.detailImage }@750W"></div>
		 		</c:otherwise>
		 	</c:choose>
        	<div class="huadongWc">
	        	<div class="picAllHead picAllHeadTwo">
				...
				<div class="neirDiv clearfix">
					<div class="shuzi fl"></div>
					<div class="cont">
	...
	<div class="zFooter zFooterTwo clearfix">
	...
	$(function () {
		...
		var picTwoSwiper = new Swiper('.picTwoSwiper', {
			onInit: function(inSwiper){
				var ele = inSwiper.slides;
				var len = inSwiper.slides.length;
				for(var i=0; i < len; i++) {
					ele.find('.shuzi').eq(i).html((i + 1) + ' / ' + len);
				}
		    }
	    });
