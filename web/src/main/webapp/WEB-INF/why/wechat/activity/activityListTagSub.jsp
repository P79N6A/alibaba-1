...
<head>
    ...
    <script type="text/javascript">
	    ...
	    if(window.injs){
	    	//分享文案
	    	appShareTitle = '我在“安康文化云”发现一大波文化活动，快来和我一起预订吧！';
        ...
        var main = avalon.define({
            ...
            activityList: function (data,index,liCount) {
                if (data.status == 0) {
                    ...
                    $.each(data.data, function (i, dom) {
            			...
            			$(".activeUl").append("<li activityId=" + dom.activityId + " onclick='toActDetail(\"" + dom.activityId + "\")'>" +
            ...
            loadDate: function (index, pagesize) {
                ...
                $.post("${path}/wechatActivity/wcTopActivityList.do", {
                	tagId: '${activityType}',
                    Lon: longitude,
                    Lat: latitude,
                    pageIndex: index,
