	...
	<script>
		...
		if (is_weixin()) {
			...
			wx.ready(function () {
				wx.onMenuShareAppMessage({
					...
					link: '${path}/muser/login.do?type=' + series_url,
		...
		function uploadImg(){
	        ...
	        if (userId ==null || userId == '') {
	            window.location.href = "${path}/muser/login.do?type=${basePath}wechatStatic/series.do";
	            return;
	        }
	...
	<div class="main">
		...
		<div class="content">
			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<a href="${path}/wechatActivity/preActivityDetail.do?activityId=3d29c2c7f1254b01a8405a6bbed4d849">
					...
					<div class="swiper-slide">
						<a href="${path}/wechatActivity/preActivityDetail.do?activityId=5aa8dafcfc58423ab91db0ca564e9c40">
					...
					<div class="swiper-slide">
						<a href="${path}/wechatActivity/preActivityDetail.do?activityId=ab1d3e4981b84cb5be0ad6e2b6a9e610">
			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<a href="${path}/wechatActivity/preActivityDetail.do?activityId=14613bbf90ae40538fd6a98bf613f5fd">
					...
					<div class="swiper-slide">
						<a href="${path}/wechatActivity/preActivityDetail.do?activityId=5f78ecc4de8747628d68b86df2091414">
					...
					<div class="swiper-slide">
						<a href="${path}/wechatActivity/preActivityDetail.do?activityId=8db75ffbe1fb4e8ab6f75afc136ca07f">
					...
					<div class="swiper-slide">
						<a href="${path}/wechatActivity/preActivityDetail.do?activityId=67b88e61820a4c23ba6515ffba6933c5">
					...
					<div class="swiper-slide">
						<a href="${path}/wechatActivity/preActivityDetail.do?activityId=65ddf49a694c43fcb371b6a1d3612b5c">
			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<a href="${path}/wechatActivity/preActivityDetail.do?activityId=c97b9285c3ed4497b2d6f158ea98859a">
					...
					<div class="swiper-slide">
						<a href="${path}/wechatActivity/preActivityDetail.do?activityId=c7445da8a9f846d3b78e0301b59c692f">
					...
					<div class="swiper-slide">
						<a href="${path}/wechatActivity/preActivityDetail.do?activityId=be2541d62e21461295d77072a8ec8f88">
					...
					<div class="swiper-slide">
						<a href="${path}/wechatActivity/preActivityDetail.do?activityId=13eb58cc2daf4848b82530b2bd039791">
					...
					<div class="swiper-slide">
						<a href="${path}/wechatActivity/preActivityDetail.do?activityId=e822534c9f464d4cb4126de860ee2841">
			...
			<a href="${path}/information/preInfo.do?informationId=14743790608a46aa9a3b83567399da60">
