...
<script type="text/javascript" src="${path}/STATIC/wechat/js/webuploader/upload-authTeamUserEdit.js"></script>
...
<script>
			$(function() {
				//页面初始化
				if('${teamUser.tuserUserType}'==1){	//个人
					$(".add-tab>ul>li:eq(0)").find("div").addClass("border-bottom2");
					$(".add-tab>ul>li:eq(0)").find("div").addClass("c5e6d98");
					$(".add-tab-content").eq(0).show();
				}else if('${teamUser.tuserUserType}'==0){	//社团
					$(".add-tab>ul>li:eq(1)").find("div").addClass("border-bottom2");
					$(".add-tab>ul>li:eq(1)").find("div").addClass("c5e6d98");
					$(".add-tab-content").eq(1).show();
				}else if('${teamUser.tuserUserType}'==2){	//公司
					$(".add-tab>ul>li:eq(2)").find("div").addClass("border-bottom2");
					$(".add-tab>ul>li:eq(2)").find("div").addClass("c5e6d98");
					$(".add-tab-content").eq(2).show();
				}
				...
				$(".add-tuser").click(function() {
		        	...
		        	if(!agree){
		        		dialogAlert('提示', '请先同意安康文化云使用协议及规则！');
		        		buttonOpen(button)
		    			return;
		        	}
		    		...
		    		formData.push({'name':'tuserId','value':'${teamUser.tuserId}'});
	...
	<div class="main">
		...
		<div class="header">
			<%-- <div class="index-top">
				...
				<span class="index-top-2">修改使用者</span>
			</div> --%>
		</div>
			...
			<div class="add-tab fs30">
				<ul>
					<li class="h80 border-right">
						<div class="c999">个人</div>
					</li>
					<li class="h80 border-right">
						<div class="c999">社团</div>
					</li>
					<li class="h80">
						<div class="c999">公司</div>
					</li>
					...
					<div class="add-tab-list">
						<div class="one">
							<div class="border-bottom padding-bottom20">
								<p class="f-left fs30">个人姓名：</p><input placeholder="请输入个人姓名" class="f-left fs30 border-none margin-top5 c808080 w500" type="text" name="tuserName" id="tuserName" value="${teamUser.tuserName}" />
								<div style="clear: both;"></div>
							</div>
							<div class="border-bottom padding-bottom20 margin-top20">
								<p class="f-left fs30">头衔/职位：</p><input placeholder="请输入头衔/职位" class="f-left fs30 border-none margin-top5 c808080 w500" type="text" name="tuserTag" id="tuserTag" value="${teamUser.tuserTag}" />
								<div style="clear: both;"></div>
							</div>
							<div class="border-bottom padding-bottom20 margin-top20">
								<p class="f-left fs30">从业年限：</p><input placeholder="请输入从业年限" class="f-left fs30 border-none margin-top5 c808080 w500" type="text" name="tuserYear" id="tuserYear" value="${teamUser.tuserYear}" />
								<div style="clear: both;"></div>
							</div>
							<div class="padding-bottom20 margin-top20">
								<p class="f-left fs30">自我介绍：</p><textarea id="tuserTeamRemark" name="tuserTeamRemark" placeholder="请输入自我介绍" class="h150 fs30 margin-top5 c808080" style="width: 500px;border: none;">${teamUser.tuserTeamRemark}</textarea>
								<div style="clear: both;"></div>
							</div>
						</div>
						<div class="add-tab-list margin-top20">
							<div class="one add-pic-list">
								...
								<ul class="user-upl margin-top20">
									<c:forEach items="${teamUserDetailPics}" var="dom">
										<script>
											var url = getImgUrl('${dom.url}');
									    	var imgUrl = getIndexImgUrl(url,"_150_150");
											$('#personForm .user-upl').prepend('<li imgUrl="'+url+'" class="uploadLi">' +
								...
								<div class="add-user-success">
									...
									<p class="f-left fs24">同意安康文化云使用协议及规则</p>
								</div>
								<div style="clear: both;"></div>
							</div>
			...
			<form id="teamForm">
				...
				<div class="add-tab-content" style="display: none;">
					<div class="add-tab-list">
						<div class="one">
							<div class="border-bottom padding-bottom20">
								<p class="f-left fs30">社团名称：</p><input placeholder="请输入社团名称" class="f-left fs30 border-none margin-top5 c808080 w500" type="text" name="tuserName" id="tuserName" value="${teamUser.tuserName}" />
								<div style="clear: both;"></div>
							</div>
	
							<div class="border-bottom padding-bottom20 margin-top20">
								<p class="f-left fs30">成立年限：</p><input placeholder="请输入从业年限" class="f-left fs30 border-none margin-top5 c808080 w500" type="text" name="tuserYear" id="tuserYear" value="${teamUser.tuserYear}" />
								<div style="clear: both;"></div>
							</div>
	
							<div class="border-bottom padding-bottom20 margin-top20">
								<p class="f-left fs30">社团人数：</p><input placeholder="请输入社团人数" class="f-left fs30 border-none margin-top5 c808080 w500" type="text" name="tuserLimit" id="tuserLimit" value="${teamUser.tuserLimit}" />
								<div style="clear: both;"></div>
							</div>
	
							<div class="border-bottom padding-bottom20 margin-top20 add-user-arrowr" onclick="getTeamUserType()">
								<p class="f-left fs30">社团类型：<span id="tuserTeamTypeName"></span><input type="hidden" id="tuserTeamType"  name="tuserTeamType" style="position: absolute; left: -9999px;" value="${teamUser.tuserTeamType}"/></p>
								<div style="clear: both;"></div>
							</div>
	
							<div class="padding-bottom20 margin-top20">
								<p class="f-left fs30">社团介绍：</p><textarea id="tuserTeamRemark" name="tuserTeamRemark" placeholder="请输入社团介绍" class="h150 fs30 margin-top5 c808080" style="width: 500px;border: none;">${teamUser.tuserTeamRemark}</textarea>
								<div style="clear: both;"></div>
							</div>
						</div>
						<div class="add-tab-list margin-top20">
								...
								<ul class="user-upl margin-top20">
									<c:forEach items="${teamUserDetailPics}" var="dom">
										<script>
											var url = getImgUrl('${dom.url}');
									    	var imgUrl = getIndexImgUrl(url,"_150_150");
									    	$('#teamForm .user-upl').prepend('<li imgUrl="'+url+'" class="uploadLi">' +
																                '<img src="'+imgUrl+'" height="150" width="150">' +
																                '<img class="user-uplrem" src="../STATIC/wechat/image/mobile_close.png"></img>' +
																             '</li>');
			...
			<form id="companyForm">
				...
				<div class="add-tab-content" style="display: none;">
					<div class="add-tab-list">
						<div class="one">
							<div class="border-bottom padding-bottom20">
								<p class="f-left fs30">公司名称：</p><input placeholder="请输公司名称" class="f-left fs30 border-none margin-top5 c808080 w500" type="text"name="tuserName" id="tuserName" value="${teamUser.tuserName}" />
								<div style="clear: both;"></div>
							</div>
	
							<div class="border-bottom padding-bottom20 margin-top20">
								<p class="f-left fs30">主营业务：</p><input placeholder="请输入主营业务" class="f-left fs30 border-none margin-top5 c808080 w500" type="text" name="tuserTag" id="tuserTag" value="${teamUser.tuserTag}" />
								<div style="clear: both;"></div>
							</div>
	
							 <div class="border-bottom padding-bottom20 margin-top20 add-user-arrowr" onclick="getCompanyType()">
								<p class="f-left fs30">公司类型：<span id="tuserTeamTypeName"></span><input type="hidden" id="tuserTeamType"  name="tuserTeamType" style="position: absolute; left: -9999px;" value="${teamUser.tuserTeamType}"/></p>
								<div placeholder="请输入从业年限" class="f-left fs30 border-none margin-top5 c808080"></div>
								<div style="clear: both;"></div>
							</div>
	
							<div class="padding-bottom20 margin-top20">
								<p class="f-left fs30">公司介绍：</p><textarea id="tuserTeamRemark" name="tuserTeamRemark" placeholder="请输公司介绍" class="h150 fs30 margin-top5 c808080" style="width: 500px;border: none;">${teamUser.tuserTeamRemark}</textarea>
								<div style="clear: both;"></div>
							</div>
						</div>
						<div class="add-tab-list margin-top20">
							<div class="one add-tuser-pic-list">
								...
								<ul class="tuser-upl margin-top20">
									<c:if test="${not empty teamUser.tuserPicture}">
									   <script>
											var tuserPic = '${teamUser.tuserPicture}';
											var tusrPic150 = getIndexImgUrl(getImgUrl(tuserPic),"_150_150");
											$('.tuser-upl').prepend('<li imgUrl="'+getImgUrl(tuserPic)+'" class="uploadLi">' +
														                '<img src="'+tusrPic150+'" height="150" width="150">' +
														                '<img class="tuser-uplrem" src="../STATIC/wechat/image/mobile_close.png"></img>' +
														            '</li>');
										</script>
									</c:if>
									<li class="user-upload border-none" >
										<div class="add-tuser-pic-button" ontouchstart="uploadTuserPic();" <c:if test="${not empty teamUser.tuserPicture}">style="display:none;"</c:if>>
											<img src="${path}/STATIC/wechat/image/add-comment.png" width="150px" height="150px" />
										</div>
									</li>
								</ul>
								...
								<ul class="user-upl margin-top20">
									<c:forEach items="${teamUserDetailPics}" var="dom">
										<script>
											var url = getImgUrl('${dom.url}');
									    	var imgUrl = getIndexImgUrl(url,"_150_150");
									    	$('#companyForm .user-upl').prepend('<li imgUrl="'+url+'" class="uploadLi">' +
																	                '<img src="'+imgUrl+'" height="150" width="150">' +
																	                '<img class="user-uplrem" src="../STATIC/wechat/image/mobile_close.png"></img>' +
																	            '</li>');
		...
		if('${teamUser.tuserUserType}'==1){	//个人
			...
			$.post("${path}/sysdict/queryCode.do",{'dictCode' : 'TEAM_TYPE'},function(data) {
	            if (data != '' && data != null) {
	               $.each(data, function (i, dom) {
	            	   if(dom.dictId=='${teamUser.tuserTeamType}'){
	            		   $("#teamForm #tuserTeamTypeName").text(dom.dictName);
	            	   }
	               });
	            }
	        });
			...
			$.post("${path}/sysdict/queryCode.do",{'dictCode' : 'COMPANY_TYPE'},function(data) {
	            if (data != '' && data != null) {
	               $.each(data, function (i, dom) {
	            	   if(dom.dictId=='${teamUser.tuserTeamType}'){
	            		   $("#companyForm #tuserTeamTypeName").text(dom.dictName);
	            	   }
	               });
	            }
	        });
