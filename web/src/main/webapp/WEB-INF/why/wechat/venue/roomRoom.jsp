...
<%@include file="/WEB-INF/why/wechat/commonFrame.jsp"%>
	...
	<script type="text/javascript">
		...
		function subUser()
		{
			var url="${path}/wechatUser/auth.do?userId="+userId+"&callback=${callback}&sourceCode=${sourceCode}";
		...
		{
			var url="${path}/wechatRoom/authTeamUser.do?userId="+userId+"&callback=${callback}&sourceCode=${sourceCode}";
...
<body>
	<form id="roomOrderForm" method="get">
	...
	<input type="hidden" id="sourceCode" name="sourceCode" value="${sourceCode }"/>
	...
	<input type="hidden" id="tuserIsDisplay" name="tuserIsDisplay" value="${tuserIsDisplay }"/>
		<div class="main">
			...
			<div class="content padding-bottom0 h250">
