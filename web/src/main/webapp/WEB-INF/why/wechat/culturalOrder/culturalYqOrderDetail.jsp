	          ...
	          //微信分享
	            wx.ready(function () {
	                ...
	                wx.onMenuShareAppMessage({
	                    title: "我在安康文化云邀请了“${order.culturalOrderName}”，你也来邀请吧！",
	                    desc: '欢迎进入安康文化云·文化点单',
		...
		<div class="footer">
			<div class="active-footmenu">
				...
				<div class="footmenu-button5" id="orderButton" style="width:438px;">
					...
					<fmt:formatDate value="${order.culturalOrderEndDate}" pattern="yyyy-MM-dd" var="endDate"/>
					<fmt:formatDate value="${now}" type="both" dateStyle="long" pattern="yyyy-MM-dd" var="nowDate"/>
					<c:choose>
					   <c:when test="${nowDate gt endDate}">
