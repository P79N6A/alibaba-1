...
<link rel="stylesheet" type="text/css" href="${path}/STATIC/wechat/css/style.css"/>
	<script>
	    ...
	    if(window.injs){
	    	//分享文案
	    	appShareTitle = '安康文化云-积分规则';
	    	appShareDesc = '拿安康文化云积分，免费预订乐山公共文化活动，更多精彩活动等您来！';
	    ...
	    if (is_weixin()) {
	        ...
	        wx.ready(function () {
	        	wx.onMenuShareAppMessage({
	                title: "安康文化云-积分规则",
	                desc: '拿安康文化云积分，免费预订乐山公共文化活动，更多精彩活动等您来！',
	                imgUrl: '${basePath}/STATIC/wx/image/share_120.png'
	            });
	            wx.onMenuShareTimeline({
	                title: "拿安康文化云积分，免费预订乐山公共文化活动，更多精彩活动等您来！",
	                imgUrl: '${basePath}/STATIC/wx/image/share_120.png'
	            });
	            wx.onMenuShareQQ({
	            	title: "安康文化云-积分规则",
	...
	<div class="main">
		...
		<div class="content padding-bottom0 margin-top100">
			<div class="point-rule-tab2 c262626">
				<p>文化引领品质生活</p>
				<p>安康文化云是一款聚焦公共文化服务领域，提供公众文化生活和消费的互联网平台，为公众提供便捷和有品质的文化生活服务。</p>
				<c:if test="${type!='app'}">
					<p>您可以通过以下方式访问安康文化云，获得免费公益文化活动机会。</p>
					<div class="waytoapp margin-bottom50">
						<ul>
							<%-- <li class="border-bottom">
								<p class="f-left">安康文化云APP</p>
				...
				<p>无论您是在PC端、微信端、亦或是APP端发现安康文化云，只需用手机号码注册，就能成为我们的会员。</p>
			</div>
			<div class="point-rule-tab2 c262626" style="display: none;">
				<p>一旦您成为了安康文化云的会员，我们会竭尽全力为您奉上最新鲜、最热门的城市文化活动服务，权益包括但不限于：会员礼遇、会员积分、会员活动、异业合作。</p>
				<p class="c7485b7">在安康文化云，您会发现更多高品质的生活，专享会员权益、便捷会员服务、丰富会员活动等你来体验！</p>
				...
				<table class="point-rule-tab margin-bottom50" style="margin-top: 50px;">
					<tbody>
						...
						<tr>
							<td>预定未核销</td>
							<td>根据活动而定</td>
							<td>安康文化云致力于为市民提供免费公益的文化活动，因活动热门，资源紧张，部分活动成功预订如果未及时到场，回扣一定的积分作为惩罚（活动内容上会有提示）；如果因个人原因实在不能及时赶到，在活动开始前取消订单将不做惩罚。</td>
						</tr>
					</tbody>
				</table>
			</div>
