...
<head>
    ...
    <script type="text/javascript">
        	...
        	if (userId == null || userId == '') {
                $("#userCenterDiv").html("<img src='${path}/STATIC/wechat/image/个人中心bg.jpg'/>" +
							    		 "<div style='position: absolute;top: 110px;left: 235px;'>" +
											"<p style='font-size: 40px;text-align: center;color: #fff;margin-bottom: 80px;'>欢迎来到安康文化云</p>" +
        ...
        // 跳转到我的培训
        function userTrianOrder(){
            if (userId == null || userId == '') {
                window.location.href = '${path}/muser/login.do?type=${basePath}wechatUser/userTrain.do';
                return;
            }
            window.location.href="${path}/wechatUser/userTrain.do";
        }
		...
		<div class="content padding-bottom0">
			...
			<div class="login-p1">
				<ul>
					...
					<li class="border-bottom" onclick="userTrianOrder();">
						<div class="login-list" >
							<p class="f-left">我的培训</p>
							<p class="f-right c999" style="margin-right:80px" id="myTrain"></p>
							<div style = "clear:both"></div>
						</div>
					</li>
