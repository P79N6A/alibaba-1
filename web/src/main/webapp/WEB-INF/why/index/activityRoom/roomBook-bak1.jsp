...
<head>
	...
	<script type="text/javascript" src="${path}/STATIC/js/index/room/roomBookFront.js?version=20151223"></script>
</head>
<body>
	...
	<div class="register-content">
		...
		<form action="${path}/frontRoom/roomBookOrder.do" method="post" id="roomBookOrderForm">
			...
			<div class="room-part1">
				...
				<div class="library_info clearfix">
					...
					<div class="library_img fl">
						<img id="roomImg" width="135" height="100" data-id="${cmsActivityRoom.roomPicUrl}"/>
					</div>
					<div class="room-info fl">
						<h3>${cmsActivityRoom.roomName}</h3>
						<p class="site">${fn:substringAfter(cmsActivityRoom.venueCity, ',')}&nbsp;${fn:substringAfter(cmsActivityRoom.venueArea, ',')}&nbsp;${cmsActivityRoom.venueAddress}&nbsp;${cmsActivityRoom.roomNo}<%--<span id="areaSpan"></span>--%></p>
						<p class="home">${cmsVenue.venueName}</p>
						<%--<p><img src="${path}/STATIC/image/hd_icon1.png" width="20" height="23"/>地址：${fn:substringAfter(cmsActivityRoom.venueCity, ',')}&nbsp;${fn:substringAfter(cmsActivityRoom.venueArea, ',')}&nbsp;${cmsActivityRoom.venueAddress}&nbsp;${cmsActivityRoom.roomNo}&lt;%&ndash;<span id="areaSpan"></span>&ndash;%&gt;</p>
						<p><img src="${path}/STATIC/image/bwg_icon.png" width="23" height="22" />所属：${cmsVenue.venueName}</p>--%>
					</div>
				</div>
				...
				<table class="tab1" width="100%" style="margin-top: 0;">
					...
					<tr>
						<td>
							...
							<input type="text" class="rp_input" name="userTel" value="${userTel != null ? userTel : cmsTerminalUser.userMobileNo}"/>
						</td>
					</tr>
					</tbody>
				</table>
			...
			<div class="book-control">
				<input type="button" value="提交订单" class="btn-submit book-submit" id="subOrder" onclick="bookSubmit()" style="background: #808080"/>
			</div>
		</form>
	</div>
</div>
