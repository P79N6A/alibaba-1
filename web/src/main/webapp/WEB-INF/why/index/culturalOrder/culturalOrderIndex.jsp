...
<head>
    ...
    <script>
        	...
        	$(".null_result").remove();
       		$.post("${path}/culturalOrder/culturalOrderList.do", $("#indexForm").serialize(), function (result) {
        		...
        		$.each(data, function (i, dom) {
                    ...
                    str += '    <p class="info info-1">服务地点： ' + dom.culturalOrderAddress + '</p>';
                    str += '  </div>';
                    str += '</li>';
        		});
    	...
    	function showOrderDetail(id){
    		window.location.href = "${path}/culturalOrder/culturalOrderDetail.do?culturalOrderId=" + id + "&culturalOrderLargeType=1&userId=" + userId; 
    	}
...
<form action="" id="indexForm" method="post">
    ...
    <input type="hidden" name="culturalOrderLargeType" id="culturalOrderLargeType" value="1"/>
    ...
    <div class="shaiChooseBox">
		<div class="aqBread">
	        <div class="breadTag cur"><a href="javascript:void(0)" onclick="showListByLargeType(1)">我要参与</a></div>
	        <em style="display: inline-block;margin: 0 24px;color: #e3e3e3;font-size: 18px">|</em>
	        <div class="breadTag "><a href="javascript:void(0)" onclick="showListByLargeType(2)">我要邀请</a></div>
	    </div>
	    ...
	    <div class="shaiChooseWrap-area">
		    ...
		    <div class="shaiChooseWrap clearfix">
		    	...
		    	<div class="kuangList clearfix" id="sortTypeDiv">
		    		...
		    		<div class="item" value="2">参与最多</div>
		    	</div>
		    </div>
	    </div>
	</div>
