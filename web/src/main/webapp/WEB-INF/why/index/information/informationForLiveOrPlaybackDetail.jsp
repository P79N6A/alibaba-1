            ...
            <div class="state">
                ...
                <c:forEach items="${info.detailList }" var="detail">
                    ...
                    <div class="videoAllShip">
                        <%--<iframe width="730" height="400" frameborder="0" allowfullscreen src="${detail.detailContent}"></iframe>--%>
                        <video style="background-color: #000" controls="controls"  width="730" height="500" src="${detail.detailContent}"></video>
                    </div>
                </c:forEach>
            </div>
        </div>
