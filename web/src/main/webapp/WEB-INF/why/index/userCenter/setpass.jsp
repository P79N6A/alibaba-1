            ...
            <div class="register-part part1">
                <dl>
                    ...
                    <dd class="showPlaceholder">
                        <input type="password" class="input-text" id="newPass" name="userPwd"  value="" maxlength="20"/>
                        <label class="placeholder" id="pwdPlaceholder">请输入6-20位字母加数字组合</label>
                ...
                <dl>
                    <dt>确认密码</dt>
                    <dd class="showPlaceholder">
                        <input type="password" id="newPass2" class="input-text" value="" maxlength="20" />
