            ...
            <form action="" id="userForm" ms-controller="dataForm">
                 <dl class="userPassword no-border">
                        ...
                        <dd>
                            <div class="showPlaceholder">
                                <input type="password" class="input-text" id="oldPass" maxlength="20"
                 ...
                 <dl class="userPassword no-border">
                    <dt>新密码</dt>
                        <dd>
                            <div class="showPlaceholder">
                                <input type="password" class="input-text" id="newPass" name="userPwd" maxlength="20"
                        ...
                        <dd>
                            <div class="showPlaceholder">
                                <input type="password" class="input-text" id="newPass2" name="confirmPassword"
                                       maxlength="20" ms-duplex="newPass2" data-duplex-changed="confirmChange" />
