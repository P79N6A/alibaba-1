...
<head>
	...
	function getActivitySearchType() {
	    $.post("${path}/beipiaoInfo/cztypelist.do?module="+module, function (data) {
	        ...
	        for (var i = 0; i < list.length; i++) {
	            var tag = list[i];
	            beipiaoinfoTagHtml += '<li><a href="javascript:setValueById(\'beipiaoinfoTag\',\'' + tag.tagId + '\');">' + tag.tagName + '</a></li>';
	        }
	...
	function loadData(){
	    ...
	    $("#activityListDivChild").load("../beipiaoInfo/ysjsList.do",{keyword:keyword,beipiaoinfoTag:beipiaoinfoTag,module:module,countPage:countPage,page:reqPage},function(){
	        //getVenueListPics();
