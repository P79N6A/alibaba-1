<%@ page contentType="text/html;application/json;charset=UTF-8" language="java" %>
<%
...
<head lang="en">
    ...
    <link href="${path}/STATIC/image/favicon.ico" rel="icon" type="image/x-icon"
          mce_href="${path}/STATIC/image/favicon.ico">
    ...
    <script type="text/javascript" src="${path}/STATIC/js/culture.js"></script>
     <script type="text/javascript" src="${path}/STATIC/js/jquery.timers.min.js"></script>
...
//        window.setInterval(readFile, 3000);
//        function readFile() {
...
//            f.Close();
//            console.log(s);
////            $.post("http://192.168.41.154:10019/ticketMachine/heartBeat", {'machineCode': s},
////                    function(data){
////                        console.log(data);
////                    } ,"json");
//
//            $.ajax({
//                type: "post",
//                url: "http://192.168.41.163:10019/ticketMachine/heartBeat",
//                data: {'machineCode': s},
...
//        }
        ...
        $(function () {
            ...
            $(".ticket-menu").on("click", ".btn", function () {
                ...
                $("#ticket-iframe").attr("src", '${path}/ticketActivity/ticketActivityList.do?machineCode='+machineCode);
                var $this = $(this);
            ...
            $(".num-board").on("click", ".key", function () {
                ...
                if (cardNumArr.length % 5 == 4) {
               	 cardNumArr.splice(cursorPos, 0, " ");
                 cursorPos++;
               }
            ...
            $('body').everyTime('600s', function() {
            	...
            	var ticketCode=$("#ticket-code").val();
        ...
        function activityPrintPiao() {
            ...
            for (var i = 0; i < seatArray.length; i++) {
                ...
                if (seat) {
                    ...
                    $.ajax({
                        ...
                        data: {"validateCode": validateCode, "seats": seat,"i":i,"machineCode":machineCode},
                        dataType: "json",
                        success: function (data) {
            ...
            else if (data.status == 14113 || data.status == 14112) {
        ...
        function printAct() {
            ...
            //LODOP.PREVIEW(); //打印预览
            LODOP.SET_LICENSES("","B31B8CD2C65B666E4366EAEEA2ADC838","C94CEE276DB2187AE6B65D56B3FC2848","");
            LODOP.PRINT();	//打印
        }
...
<input type="hidden" id="machineCode" value="${machineCode }"/>
<div id="ticket-top">
...
<div id="ticket-content">
            ...
            <div class="take-ticket">
                <form name="formColl">
                    ...
                    <script language="JavaScript">
							 var test = document.getElementById("ticket-code")
        ...
        <div id="printsfz" style="display:none">
            <div id="page1">
                <div class="ticket-print" style="width: 320px;">
                    <div style="padding: 20px;">
                        <div style="height: 32px; overflow: hidden;">
                            ...
                            <div style="float: left; border-left: solid 5px #080808; padding-left: 5px; margin:1px 0 1px 10px; height: 30px;">
                                ...
                                <p style="line-height: 12px; font-size: 7pt; font-family: Arial;">Activity
                                    Appointment</p>
                            </div>
                        </div>
                    ...
                    <div style="height: 25px; line-height: 25px; text-align: center; background: #9a9a9a; color: #ffffff; font-size: 10px;">
                        更多精彩内容请访问：http://www.wenhuayun.cn
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="ticket-part ticket-page" id="ticketPage" style="display: none;">
        <iframe src="${path}/ticketActivity/ticketActivityList.do" frameborder="0" width="100%" height="100%"
                id="ticket-iframe" style="background: transparent;"></iframe>
    </div>
</div>
</div>
</body>
