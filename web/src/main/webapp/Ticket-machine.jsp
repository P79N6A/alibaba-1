            ...
            for (var i = 0; i < seatArray.length; i++) {
                ...
                if (seat) {
                    ...
                    $.ajax({
                        ...
                        data: {"validateCode": validateCode, "seats": seat,"i":i},
                        dataType: "json",
                        success: function (data) {
...
<div id="ticket-content">
                ...
                <div class="ticket-print" style="width: 320px;">
                    <div style="padding: 20px;">
                        <div style="height: 32px; overflow: hidden;">
                            <div style="float: left;"><img src="STATIC/image/logo-print.png" alt="" height="30"/></div>
    ...
    <%@include file="/WEB-INF/why/ticket/ticketHeart.jsp" %>
</div>
</div>
</body>
</html>