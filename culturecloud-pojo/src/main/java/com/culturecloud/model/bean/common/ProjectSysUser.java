...
public class ProjectSysUser implements Serializable{
    /**
	 * 
	 */
	private static final long serialVersionUID = 7756792793916956527L;
    ...
    private List<ProjectModule> sysModuleList;
	...
	public List<ProjectModule> getSysModuleList() {
		return sysModuleList;
	}

	public void setSysModuleList(List<ProjectModule> sysModuleList) {
