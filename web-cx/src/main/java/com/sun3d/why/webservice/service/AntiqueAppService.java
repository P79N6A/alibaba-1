...
public interface AntiqueAppService {
    ...
    String queryAppAntiqueList(String antiqueTypeName,String antiqueDynasty, PaginationApp pageApp,String venueId);
     ...
     * @return
     */
    String queryAppAntiqueById(String antiqueId,String userId);
}
