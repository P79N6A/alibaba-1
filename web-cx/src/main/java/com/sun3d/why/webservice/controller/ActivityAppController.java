...
public class ActivityAppController {
    ...
    public String appActivityOrder(HttpServletRequest request, HttpServletResponse response,String activityId,String userId,String activityEventIds,
        ...
        try {
            if (StringUtils.isBlank(userId) && StringUtils.isBlank(activityId)) {
                ...
                json=activityAppService.appActivityOrderByCondition(activityId,userId,activityEventIds,bookCount,orderMobileNum,orderPrice,activityEventimes,seatId,seatValues,orderName, orderIdentityCard,costTotalCredit);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public void appEveryDateActivityCount(HttpServletResponse response, String startDate, String endDate, String version) throws Exception{
        String json = "";
        try {
    ...
    public String appCmsActivityListByCondition(String activityArea, String activityType, String activityName,String activityIsReservation, String Lon,String Lat,HttpServletResponse response,String pageIndex,String pageNum,PaginationApp pageApp) throws Exception {
        pageApp.setFirstResult(Integer.valueOf(pageIndex));
        pageApp.setRows(Integer.valueOf(pageNum));
        String json="";
        try {
            json=activityAppService.queryAppCmsActivityListByCondition(activityArea, activityType, activityName,activityIsReservation, pageApp, Lon,Lat);
        }catch (Exception e){
            e.printStackTrace();
    ...
    public String appTopActivityList(String pageIndex,String pageNum,String tagId,PaginationApp pageApp,HttpServletResponse response,
    		String activityArea,String activityLocation,String activityIsFree,String activityIsReservation,String sortType,String Lon,String Lat) throws Exception {
        String json = "";
        pageApp.setFirstResult(Integer.valueOf(pageIndex));
        pageApp.setRows(Integer.valueOf(pageNum));
        ...
        try {
            json = activityAppService.queryTopActivityList(pageApp, tagId, activityArea, activityLocation, activityIsFree, activityIsReservation, sortType, Lon, Lat);
        }catch (Exception e){
            e.printStackTrace();
...
//    }
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/appActivityListTagSub")
	public void appActivityListTagSub(HttpServletResponse response) throws Exception {
