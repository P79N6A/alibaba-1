...
public interface UserOrderAppService {
     ...
     * why3.5 app显示或搜索用户活动与活动室订单信息（当前未过期订单）
     * @param pageApp 分页对象
     * @param orderPhoneNo 订单手机号
     * @return
     */
    String queryAppUserOrderByOrderPhoneNo(PaginationApp pageApp, String orderPhoneNo) throws Exception;
     ...
     * @throws Exception
     */
    String queryAppUserPayOrderByUserId(PaginationApp pageApp, String userId) throws Exception;
