...
/*            if(record.getAntiqueIsDel() != null){
            ...
            if(StringUtils.isNotBlank(record.getAntiqueVenueId())){
                map.put("antiqueVenueId",record.getAntiqueVenueId());
            }
    ...
    public List<CmsAntique> queryByCmsAntique(CmsAntique record){
        ...
        try {
            ...
            if(record.getAntiqueVenueId() != null){
                map.put("antiqueVenueId",record.getAntiqueVenueId());
            }
    ...
    public List<CmsAntique> queryAntiqueDetailList(CmsAntique cmsAntique){
        ...
        try {
            ...
            condition.setAntiqueVenueId(cmsAntique.getAntiqueVenueId());
