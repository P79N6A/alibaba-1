		  ...
		  try {
	            ...
	            if(selectTemplate!=null)
	            {
	            	...
	            	if(selectTemplate==2){
	            		...
	            		if(StringUtils.isNotBlank(topic.getTemplateId())){
	            			CcpContestTemplate ccpContestTemplate=contestTemplateService.selectContestTemplateById(topic.getTemplateId());
		            		// 已有模板是系统模板  需要去掉
		            		if(ccpContestTemplate.getTemplateIsSystem()!=null&&ccpContestTemplate.getTemplateIsSystem()==1)
