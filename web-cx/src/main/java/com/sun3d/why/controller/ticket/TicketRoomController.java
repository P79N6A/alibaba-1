...
/**
 * @Title: TicketRoomController
 * @Package com.sun3d.why.controller.ticket
 * @Description: 【订票-活动室模块】对应请求的处理
 * @Author CJ
 * @Date 2015/12/24
 * @Version V3.1
 */
@RequestMapping(value = "/ticketRoom")
@Controller
public class TicketRoomController {

    /**
     * 日志
     */
    private Logger logger = Logger.getLogger(TicketRoomController.class);
    /**
     * 场馆所有服务接口
     */
    @Autowired
    ...
    public ModelAndView roomDetail(String roomId){
        ...
        model.setViewName("ticket/room/ticketRoomDetail");
    ...
    public ModelAndView roomBook(String roomId,String bookId,String tuserId,String userTel){
        ...
        model.setViewName("ticket/room/ticketRoomBook");
        model.addObject("cmsActivityRoom", cmsActivityRoom);
        model.addObject("cmsVenue",cmsVenue);
        model.addObject("teamUserList",teamUserList);
    ...
    public ModelAndView roomBookOrder(CmsRoomBook cmsRoomBook,String curDateStr,String tuserName){
        ...
        model.setViewName("ticket/room/ticketRoomBookOrder");
        model.addObject("cmsVenue",cmsVenue);
        model.addObject("cmsActivityRoom",cmsActivityRoom);
    ...
    public ModelAndView roomOrderConfirm(CmsRoomBook cmsRoomBook){
        ...
        model.setViewName("ticket/room/ticketRoomBookSuccess");
        model.addObject("cmsActivityRoom",cmsActivityRoom);
