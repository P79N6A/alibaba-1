...
public class SmsMail {
	    ...
	    // 邮件标题
	    private static String mail_subject = "短信使用错误信息";
	    ...
	    public SmsMail() throws AddressException {
	     ...
	     * 此段代码用来发送普通电子邮件
	     */
	    public static boolean send(Date date,String rows) throws Exception {
	           ...
	           // message.setText("您好，您的文化云账户已经注册成功，请点击http://localhost:8080/updateTerminalUserDisable.do?userId=" + URLEncoder.encode(id, "UTF-8") + "激活帐号！"); // 设置邮件正文
	            ...
	            sb.append("</HEAD>");
	            sb.append("<BODY>");
	            sb.append("<p>【上海文化云】短信流量通知："+sdf.format(new Date())+"  已使用条数："+rows+" </p>");
