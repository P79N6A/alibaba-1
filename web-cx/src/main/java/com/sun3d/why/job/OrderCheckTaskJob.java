...
import com.sun3d.why.mail.OrderCheckMail;
...
public class OrderCheckTaskJob {
	...
	public void orderCheck(){
		...
		// 查询订单列表
		List<CmsActivityOrder> orderList=cmsActivityOrderMapper.queryCheckOrderList(map);
	...
	private String getOrderInfo(String activityOrderId){
		...
		sb.append(" 下单时间："+orderCreateTime!=null?DateUtil.formatDate(orderCreateTime,DateUtils.DATE_PATTERN_yyyy_MM_dd_HH_MM):"");
	...
	private HashMap<String,String> getParamConfigMap (){
		...
		List<SysParamsConfig> params=sysParamsConfigService.queryParamsConfigByBusinessId(BUSINESS_NAME);
