...
<script type="text/javascript" >
	...
	window.console = window.console || {log:function () {}}
      ...
      function doSubmit(){
		  ...
		  $.post("${path}/questionAnwser/addQuestionAnwser.do", $("#anwserQuestionForm").serialize(),
		        function(data) {
...
<input type="hidden" id="isCutImg" value="N"/>
  <form action="" id="anwserQuestionForm" method="post">
      <div class="site">
          <em>您现在所在的位置：</em>运维管理 &gt; 添加互动问答
      </div>
      <div class="site-title">添加新问题</div>
      <div class="main-publish">
          <table width="100%" class="form-table">
              <tr>
                  <td width="100" class="td-title"><span class="red">*</span>题目：</td>
                  <td class="td-input" id="anwserQuestionLabel">
                      <input type="text" id="anwserQuestion" name="anwserQuestion" class="input-text w510"  maxlength="20" />
                  </td>
              ...
              <tr>
	               ...
	               <td class="td-upload" id="anwserImgUrlLabel">
	                   <table>
	                       <tr>
	                           <td>
	                                <input type="hidden"  name="anwserImgUrl" id="anwserImgUrl" value="">
              ...
              <tr>
                  ...
                  <input type="hidden" id="anwserAllCode" name="anwserAllCode"/>
              ...
              <tr>
                  ...
                  <td class="td-input" id="anwserCodeLabel">
                      <input type="text" id="anwserCode" name="anwserCode" class="input-text w410"  maxlength="1" />
                  </td>
              </tr>
              <tr class="td-btn">
                  <td></td>
