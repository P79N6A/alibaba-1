...
<div class="in-content">
  <div class="search in-tit1">
    <h2>截至昨日数据统计，佛山文化云注册会员共有 <span class="red">${userStatistics.sCount}</span> 人</h2>
  ...
  <%--<div class="in-part1">
    <div class="in-part1-tip">
      <div class="txt1 fl">截至昨日数据统计，佛山文化云注册会员共有 <span class="red">${userStatistics.sCount}</span> 个</div>
