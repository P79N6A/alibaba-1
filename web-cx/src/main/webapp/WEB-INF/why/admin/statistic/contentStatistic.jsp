...
<div class="in-content">
  ...
  <div class="in-part1">
    <div class="in-part1-tip">
      <div class="txt1 fl">截至昨日数据统计，佛山文化云共有场馆 <span class="red" id="venueTotal"></span> 个</div>
    </div>
  ...
  <div class="in-part1">
    <div class="in-part1-tip">
      <div class="txt1 fl">截至昨日数据统计，佛山文化云共有藏品 <span class="red" id="antiqueTotal"></span> 件</div>
    </div>
    <div class="in-container">
  ...
  <div class="in-part1">
    <div class="in-part1-tip">
      <div class="txt1 fl">截至昨日数据统计，佛山文化云共有活动室 <span class="red" id="roomTotal"></span> 间</div>
    </div>
    <div class="in-container">
      <div id="roomData"></div>
    </div>
