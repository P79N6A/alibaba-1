...
<head>
    ...
    <script type="text/javascript">
        ...
        function formSub(formName){
            ...
            if(activityName!=undefined&&activityName=='输入关键字'){
                $('#activityName').val("");
            }
...
<div class="search">
    <div class="search-box">
        <input type="text" id="activityName" name="activityName" value="<c:choose><c:when test="${empty activity.activityName}">输入关键字</c:when><c:otherwise>${activity.activityName}</c:otherwise></c:choose>" data-val="输入关键字" class="input-text"/>
    </div>
