     	...
     	function sub(){
     		...
     		if(text)
     		{
     			...
     			var data= $("#form").serializeArray();
     			 ...
     			 $.post('${path}/cmsRoomOrder/subRefuse.do',data,function(result){
...
<input type="hidden" id="bookStatus" name="bookStatus" value="2"> 
<input type="hidden" id="checkStatus" name="checkStatus" value="2">
<!-- 正中间panel -->
<div id="content">
    <div class="content">
