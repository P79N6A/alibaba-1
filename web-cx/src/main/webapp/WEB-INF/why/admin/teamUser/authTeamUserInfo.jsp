...
<head>
    ...
    <script type="text/javascript">
        ...
        function passPerson(){
        	...
        	if(c)
        	{
        		data.push({'name':'tuserIsDisplay','value':1});
        ...
        function refuse(){
        	...
        	dialog(
    				{
    					url : '${path}/teamUser/authRefuse.do?tuserId='+tuserId+'&roomOrderId='+roomOrderId+'&applyId='+applyId
    							+'&userId='+userId+'&tuserIsActiviey='+tuserIsActiviey,
    					title : '填写拒绝理由',
    					width : 520,
    					height : 240,
    					fixed : true
...
<c:when test="${teamUser.tuserIsDisplay==0 }">
	<div class="site-title">使用者认证</div>
</c:when>
<c:otherwise>
        ...
        <div class="con-box-blp">
        	...
        	<td width="150px" class="td-title">操作日志：</td>
                            ...
                            <tr class="td-btn" style="margin-top:15px;">
                               ...
                               <c:choose>
								<c:when test="${teamUser.tuserIsDisplay==1||teamUser.tuserIsDisplay==2||teamUser.tuserIsDisplay==3 }">
								...
								<c:when test="${teamUser.tuserIsDisplay==0 }">
		                    	   ...
		                    	   <input type="button" value="通过" onclick="passTeam()" class="btn-save"
                                                       style="margin-left: 155px;margin-top: 20px;"/>
                            ...
                            <tr class="td-btn" style="margin-top:15px;">
                               ...
                               <c:choose>
								...
								<c:when test="${teamUser.tuserIsDisplay==0 }">
		                    	   ...
		                    	   <input type="button" value="通过" onclick="passPerson()" class="btn-save"
                                                       style="margin-left: 155px;margin-top: 20px;"/>
                            ...
                            <tr class="td-btn" style="margin-top:15px;">
                               ...
                               <c:choose>
								...
								<c:when test="${teamUser.tuserIsDisplay==0 }">
		                    	   ...
		                    	   <input type="button" value="通过" onclick="passCompany()" class="btn-save"
                                                       style="margin-left: 155px;margin-top: 20px;"/>
