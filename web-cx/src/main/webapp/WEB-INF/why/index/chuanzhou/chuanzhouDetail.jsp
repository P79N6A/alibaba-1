...
<head>
    ...
    <script type="text/javascript">
	    ...
	    $(function(){
	        ...
	        //加载视频
	        var cultureVediourl = '${bpInfo.beipiaoinfoVideo }';
...
<div class="lm_main clearfix">
    <p class="lm-breadcrumbs">您所在的位置：
        <a href="${path}/beipiaoInfo/chuanzhouIndex.do"><span>人文佛山</span></a> &gt;
    ...
    <!-- 详情 -->
    <div class="left">
        <p class="name">${bpInfo.beipiaoinfoTitle }</p>
        <div class="time clearfix">
            <fmt:formatDate value="${bpInfo.beipiaoinfoUpdateTime}" pattern="yyyy-MM-dd HH:mm"/>
            <div class="state">
            	<span class="zan_lm" onclick="addWantGo('${bpInfo.beipiaoinfoId }',20,'$(this)')">${wantgoCount }</span>
        ...
        <c:if test="${bpInfo.beipiaoinfoShowtype=='0' }">
        	<div class="qiehuan">
	            <div class="datu">
	                <ul>
	                	<c:set value="${ fn:split(bpInfo.beipiaoinfoImages, ';') }" var="images" />
						<c:if test="${images==''}">
        ...
        <div id="vedioDiv" style="text-indent: 0; margin: 20px auto;"></div>
        	<%-- <video id="video" src="${bpInfo.beipiaoinfoVideo }" 
        			style="object-fit:fill;width: 725px;height: 485px;" controls webkit-playsinline="true" playsinline="true" 
    ...
    <div class="right">
        ...
        <ul>
        	<c:forEach items="${recommendList }" var="info">
        		<li>
                <div class="img"><a href="${path}/beipiaoInfo/bpInfoDetail.do?infoId=${info.beipiaoinfoId}" class="img"><img src="${info.beipiaoinfoHomepage }" width="100%" height="149"></img></a></div>
                <div class="p">${info.beipiaoinfoTitle }</div>
            </li>
        	</c:forEach>
        </ul>
    </div>
