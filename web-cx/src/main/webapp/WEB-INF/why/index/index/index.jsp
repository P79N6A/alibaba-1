...
<div class="fsMain">
	...
	<div class="biaoTopWrap clearfix">
		<div class="titZong fl">文化活动<span>/ activity</span></div>
		<div class="huoNavList clearfix fl" id="activitySearchType">
			<a class="cur" href="javascript:;">最新发布</a>
			<!-- <a href="javascript:;" data-val="ccf3d2fd87ff4ae79ab7fff95fc20fb5">演 出</a>
			<a href="javascript:;" data-val="活动">亲 子</a>
			<a href="javascript:;" data-val="活动">展 览</a>
			<a href="javascript:;" data-val="活动">讲 座</a>
			<a href="javascript:;" data-val="活动">公益电影</a>
			<a href="javascript:;" data-val="活动">培 训</a> -->
		</div>
	...
	<!-- start 场馆 -->
	<!-- start 文化地图 & 热门场馆 -->
	<div class="syMapVenTit">
		<a class="cur" href="javascript:;">热门场馆<em></em></a>&emsp;/&emsp;
		<a href="javascript:;">文化地图<em></em></a>
	</div>
	<div class="syMapVenCont">
		...
		<div class="cultureMap contNeic" id="cultureMap" style="height: 560px;display:none;"></div>
			<!-- <a href="javascript:;" style="display: block;width: 120px;margin: 0 auto; height: 34px;line-height: 34px;background-color: #dbdbdb;font-size: 12px;color: #333333;text-align: center;">全部场馆</a> -->
	...
	<!-- start 动态资讯 -->
	<div class="biaoTopWrap clearfix">
		<div class="titZong fl">动态资讯<span>/ news</span></div>
		<a class="more fr" href="${path}/beipiaoInfo/chuanzhouIndex.do">更多&nbsp;&gt;&gt;</a>
	</div>
	...
	<!-- start 特色活动 -->
	<div class="biaoTopWrap clearfix">
		<div class="titZong fl">特色活动<span>/ activity</span></div>
		<a class="more fr" href="${path}/frontActivity/activityList.do">更多&nbsp;&gt;&gt;</a>
	</div>
	...
	<div class="fs-rightNav">
		...
		<a href="${path}/cultureMap/cultureMapList.do"><span>文化<br>地图</span></a>
		<a href="${path}/beipiaoInfo/chuanzhouIndex.do"><span>动态<br>资讯</span></a>
		<a href="${path}/frontResource/resourceIndex.do"><span>资源库</span></a>
		<a href="${path}/league/leagueIndex.do"><span>文化<br>联盟</span></a>
		<a href="http://www.gdzyz.cn/"><span>文化<br>志愿者</span></a>
		<a href="${path}/culturalOrder/culturalOrderIndex.do"><span>文化<br>点单</span></a>
...
<script type="text/javascript">
    ...
    function loadpctuijianVenueIndex(){
        $("#tuijianVenues").load("${path}/bpFrontIndex/advertIndex.do?type=D #tuijianVenuesDiv",null, function () {
            ...
            $("#tuijianVenues").append('<a href="${path}/frontVenue/venueList.do" style="display: block;width: 120px;margin: 0 auto; height: 34px;line-height: 34px;background-color: #dbdbdb;font-size: 12px;color: #333333;text-align: center;">全部场馆</a>');
        });
	}
  //推荐资讯
	    ...
	    for (var i in data) {
	        if (data[i].advertState != undefined && data[i].advertState == 1 && data[i].advertImgUrl != "") {
	            ...
	            if ("" == connectUrl || connectUrl.indexOf("http") == -1) {
	                htmlimg += "<li><a><img src='" + getIndexImgUrl(imgUrl,"_1220_500") + "'/></a></li>";
	            } else {
	                htmlimg += "<li><a target='_blank' href='" + connectUrl + "'><img src='" + getIndexImgUrl(imgUrl,"_1220_500") + "'/></a></li>";
	            }
	        }
	    }
    ...
    var infoMapWindow = new AMap.AdvancedInfoWindow({
	...
	function loadData(){
		...
		$.post("${path}/wechatVenue/queryVenueByType.do",null, function (data) {
			if(data.status==1){
				infoJson = new Array();
				$.each(data.data, function (i, dom) {
						infoJson.push({
