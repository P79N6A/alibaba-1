...
<head>
    ...
    $(function() {
        ...
        function getActivityList(countPage,page){
            ...
            $("#userActivityHistorys").load("${path}/userActivity/publicActivityLisLoad.do",{
...
<div class="activity-content user-content clearfix">
    ...
    <div class="user-right fr">
        <div class="user-tab" id="webDiv">
            <a href="${path}/userActivity/prePublicActivityList.do" class="cur">活动管理</a>
            <a href="${path}/userActivity/prePublicActivityListDrafts.do" >草稿箱</a>
