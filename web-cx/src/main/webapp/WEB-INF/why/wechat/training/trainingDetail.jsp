...
<head>
    ...
    <script>
        ...
        if (window.injs) {
            //分享文案
            appShareTitle = '我正在佛山文化云观看艺术培训课程“${training.trainingTitle}”';
            appShareDesc = '佛山文化云·艺术培训，精彩培训视频在线观看';
        ...
        if (is_weixin()) {
            ...
            wx.ready(function () {
                wx.onMenuShareAppMessage({
                    title: "我正在佛山文化云观看艺术培训课程“${training.trainingTitle}”",
                    desc: '佛山文化云·艺术培训，精彩培训视频在线观看',
