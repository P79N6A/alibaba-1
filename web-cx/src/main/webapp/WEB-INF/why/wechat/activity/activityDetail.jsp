        ...
        if (is_weixin()) {
            ...
            wx.ready(function () {
                ...
                wx.onMenuShareAppMessage({
                    title: "我在佛山文化云免费预订了一个超棒的文化活动-[${activity.activityName}]",
			...
			<div class="active-top">
				<ul>
					...
					<li>
						...
						<p style="color: #929edb;float: left;" id="activityTel"></p>
						<div style="clear: both;"></div>
					</li>
				</ul>
			</div>
		...
		<div class="footer">
			<div class="active-footmenu">
				<%--<ul style="float: left;">--%>
					...
					<%--<div style="clear: both;"></div>--%>
				<%--</ul>--%>
				<div class="footmenu-button5" id="orderButton" style="width: 100%"></div>
				<div style="clear: both;"></div>
			</div>
		</div>
