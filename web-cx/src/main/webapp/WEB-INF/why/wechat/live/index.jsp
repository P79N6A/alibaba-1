...
<head>
	...
	if (userId == null || userId == '') {
		//判断登陆
    	publicLogin('${basePath}wechatLive/index.do');
	}
	
	//分享是否隐藏
    if(window.injs){
    	//分享文案
    	appShareTitle = '佛山文化云-专注文化直播上万家文化机构活动现场正在播报，抢鲜看';
	...
	if (is_weixin()) {
		...
		wx.ready(function () {
			wx.onMenuShareAppMessage({
				title: "佛山文化云-专注文化直播上万家文化机构活动现场正在播报，抢鲜看",
				desc: '导赏看展览，专业艺术启蒙，文化大咖面对面，艺术活动现场看.....文化活动尽在掌握',
				link: '${basePath}wechatLive/index.do',
	...
	function getUserHead(userHeadImgUrl){
		...
		if(!userHeadImgUrl||userHeadImgUrl.indexOf("http") == -1){
        	...
        	userHeadImgUrl=userHeadImgUrl+"@36w"
        }
	...
	<div class="twzbMain" >
		<div class="bgWhite" style="left:0;top:0;z-index:11;">
				
		</div>
		<div class="swiper-container twzbBanner">
	      <div id="indexBannerList" class="swiper-wrapper"></div>
