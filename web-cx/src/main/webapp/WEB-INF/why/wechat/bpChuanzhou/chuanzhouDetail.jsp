...
<html>
	<head>
		...
		<script type="text/javascript">
            ...
            if(window.injs){
                //分享文案
                appShareTitle = '我在佛山文化云发现了一个非常棒的资讯-[${bpInfo.beipiaoinfoTitle}]';
	          ...
	          //微信分享
	            wx.ready(function () {
	                ...
	                wx.onMenuShareAppMessage({
	                    title: "我在佛山文化云发现了一个非常棒的资讯-[${bpInfo.beipiaoinfoTitle}]",
	                    desc: '汇聚佛山最全文化资讯',
			...
			<div class="content" style="padding-bottom: 0;">
				...
				<c:if test="${bpInfo.beipiaoinfoShowtype==0 }">
					...
					<c:if test="${not fn:contains(bpInfo.beipiaoinfoImages,';')}">
						<div class="active-top-bor">
							<img class="masking-down" src="${bpInfo.beipiaoinfoImages}" width="750" height="475">
				...
				<div class="bpRwczDetailName">
					...
					<div class="clearfix bpRwczPlace">
						...
						<span class="f-right">${bpInfo.parentTagInfo}</span>
					</div>
				</div>
