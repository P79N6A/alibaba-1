...
<head>
    ...
    <meta name="description" content="佛山文化云-一款聚焦文化领域，提供公众文化生活服务和文化消费的文化互联网平台，现汇聚全上海22万场文化活动、5500余文化场馆资源，为用户提供便捷的文化品质生活服务。">
				...
				<div class="a_note" style="padding:34px 15px 35px 15px;">
					<div class="zbTitle clearfix" style="margin-bottom: 30px;">
						...
						<div class="wenzi" style="float: left;margin-left: 15px;">
							<div class="t" style="font-size: 18px;color: #121212;font-weight: bold;line-height: 26px;height: 26px;overflow: hidden;margin-top: 3px;">lol小智直播 剑圣打野 无形之浪最为致命</div>
							<div class="xg clearfix" style="font-size: 13px;color: #121212;margin-top: 5px;"><div class="x" style="float: left;height: 20px;line-height: 20px;overflow: hidden;max-width: 300px;white-space:nowrap;text-overflow:ellipsis;-o-text-overflow:ellipsis;overflow:hidden;">小智</div><div class="g" style="float: left;height: 20px;line-height: 20px;overflow: hidden;background: url(http://culturecloud.img-cn-hangzhou.aliyuncs.com/H5/201736154613FHhkIh8Ldz27B9XZCyeFUC8zCiWwpQ.png) no-repeat left center;padding-left: 20px;margin-left: 55px;">3281人</div></div>
						</div>
					</div>
	
					<video style="display: block;width: 100%;height: auto;" controls="controls" preload="auto" autoplay="autoplay" src="http://culturecloud.img-cn-hangzhou.aliyuncs.com/H5/20173895632sz9W3NsjicTuBAEastxe4tOP5McL3T.mp4"></video>
					...
					<div class="shares">
				        ...
				        <span class="bdsharebuttonbox bdshare-button-style0-16" data-bd-bind="1488772070934">
					        ...
					        <a class="zan" id="zanId"><span class="likeCount">981</span></a>
	                ...
	                <div class="ad_intro" style="padding-top: 20px;">
						<p>
							lol小智直播 剑圣打野 无形之浪最为致命lol小智直播 剑圣打野 无形之浪最为致命lol小智直播 剑圣打野 无形之浪最为致命lol小智直播 剑圣打野 无形之浪最为致命lol小智直播 剑圣打野 无形之浪最为致命lol小智直播 剑圣打野 无形之浪最为致命lol小智直播 剑圣打野 无形之浪最为致命
						</p>
						<p>
							lol小智直播 剑圣打野 无形之浪最为致命lol小智直播 剑圣打野 无形之浪最为致命lol小智直播 剑圣打野 无形之浪最为致命lol小智直播 剑圣打野 无形之浪最为致命lol小智直播 剑圣打野 无形之浪最为致命lol小智直播 剑圣打野 无形之浪最为致命lol小智直播 剑圣打野 无形之浪最为致命
						</p>
		...
		<div class="detail_right fr">
			...
			<div class="recommend mb20">
				...
				<ul class="recommend-list">
					...
					<li>
						<a href="${path}/wechatStatic/pcLive2.do" class="img">
							<img src="http://culturecloud.img-cn-hangzhou.aliyuncs.com/H5/201736173816GZ8VbND1cYlpOmCARRCuS08YYJbgu6.png@280w" alt="" width="280" height="210"/>
						</a>
						<div class="info">
							<h3><a target="_blank" href="javascript:;">中单剑姬vs飞机，剑姬已经起飞了</a></h3>
							<p title="">lol小智直播</p>
						</div>
					</li>
				</ul>
