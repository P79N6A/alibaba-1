...
<body>
				...
				<li>
					<div class="ccData">
						<ul>
							...
							<li>
								<div>
									<div class="tabTitle">重庆市江津区文化委员会</div>
									<div>
										<div class="ccDataImg">
											<img src="${path}/STATIC/cc/image/word.png" />
										</div>
	...
	<div class="ccDetailMain" id="ccDetailMain1" style="display: none;height: 100%;width: 100%;margin: auto;background-color: #fff;">
			...
			<div class="ccDetail">
				...
				<p style="text-indent:2em;" class="ccDetailFont">李欣表示，“文化上海云”可视为是政府引进社会力量来参与公共文化服务，引进创图参与上海“互联网＋公共服务”的建设。而依托大数据技术和海量的用户行为分析，佛山文化云还能够提供更为精准的文化供需服务。比如根据不同地域、不同时段的用户需求变化，平台可以为其推送不同的文化服务信息。</p><br />
