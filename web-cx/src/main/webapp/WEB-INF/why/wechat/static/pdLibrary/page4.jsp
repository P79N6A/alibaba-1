...
<body>
	...
	<div class="pdtsg pdtsgsy">
	    ...
	    <div class="pdsytit jz630"><img src="http://img1.wenhuayun.cn/pdlibraryStatic/tit20.png"></div>
	
	    <ul class="lableyans jz630">
	    	<li><a href="${path}/wechatStatic/pdLibrary.do?page=6&point=0"><img src="http://img1.wenhuayun.cn/pdlibraryStatic/lable1.png"></a></li>
	    	<li><a href="${path}/wechatStatic/pdLibrary.do?page=6&point=2"><img src="http://img1.wenhuayun.cn/pdlibraryStatic/lable2.png"></a></li>
	    </ul>
	</div>
