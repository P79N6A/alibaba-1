...
<script>
	...
	$(function(){
			...
			if (userId == null || userId == '') {
	        	window.location.href = '${path}/muser/login.do?type=${basePath}wechatUser/userIntegralAll.do';
	        }else{
	  ...
	  function loadData(index, pagesize,userId) {
		  $.ajax({
    			type: 'post',  
	  			url : "${path}/wechatUser/userIntegralDetailAll.do",  
	  			dataType : 'json',  
	...
	<div class="main">
		<div class="content padding-bottom0">
			<div class="my-point bg7279a0 cfff">
				<p class="fs30 my-point-num">您有<span class="fs80 margin-left10 margin-right10" id="integralNow"></span>积分</p>
