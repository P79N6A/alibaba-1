;(function ($) {
    ...
    function Show(params, caller) {
        ...
        Content.push("<div id=\"DialogBySHF\" style=\"width:" + PARAMS.Width + "px;height:" + PARAMS.Height + "px;left:" + positionLeft + "px;top:10%;\">");
        ...
        if (caller == "Dialog") {
            ...
            Content.push("        <table>");
            Content.push("            <tr><td id=\"TipLine\" style=\"height:160px;\">" + PARAMS.Content + "</td></tr>");
            Content.push("            <tr>");
