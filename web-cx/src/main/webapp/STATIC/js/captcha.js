 ...
 * author ehong[idehong@gmail.com]
  + '<span id="ehong-code-tip-ck" class="ehong-code-val-tip" onclick="$.idcode.setCode()">'+ settings.codeTip +'</span>'
...
(function($){
	...
	function _setStyle(codeObj){
		...
		var col = new Array('#BF0C43', '#E69A2A','#707F02','#18975F','#BC3087','#73C841','#780320','#90719B','#1F72D8','#D6A03C','#6B486E','#243F5F','#16BDB5','#ED3838','#FF9326','#ACB4C3');
		var charIndex;
