...
(function (h, o, g) {
    ...
    g[h] = {
        ...
        settings: {
            ...
            loop: false,
            preload: true,
            imageLocation: 'image/play-icon1.gif',
            ...
            createPlayer: {
                markup: '             <div class="play-pause">             <p class="play"></p>             <p class="pause"></p>             <p class="loading"></p>             <p class="error"></p>           </div>           <div class="scrubber">             <div class="progressaa"></div>             <div class="progress"></div>             <div class="loaded"></div>           </div>           <div class="time">             <em class="played">00:00</em>/<strong class="duration">00:00</strong>           </div>           <div class="volume"></div>           <div class="error-message"></div>',
            ...
            css: '.audiojs audio { position: absolute; left: -1px; }.audiojs {font-size: 12px; width:270px; height:18px; padding:25px 8px 24px 28px; background:url(image/play-bg.png) no-repeat;}        .audiojs .play-pause { width: 18px; height: 18px; float: left; overflow: hidden; }         .audiojs p { display: none; width: 18px; height: 18px; margin: 0px; cursor: pointer; }         .audiojs .play { display: block; }         .audiojs .scrubber { position: relative; float: left; width: 158px; height: 3px; margin: 7px; border:solid 1px #cacaca;}           .audiojs .progressaa{ position: absolute; top: 0px; left: 0px; height: 3px; width: 0px; background: #f58636; z-index: 1;}         .audiojs .progress { position: absolute; top:-3px; left: 0px; height: 8px; width: 9px; background:url(image/play-dot.png) no-repeat; z-index: 1;}         .audiojs .loaded { position: absolute; top: 0px; left: 0px; height: 3px; width: 0px;}         .audiojs .time { float: left; height: 18px; line-height: 18px; color:#4a4a4a;}         .audiojs .time em { font-style: normal; }         .audiojs .time strong { font-weight: normal; }          .volume{ display:none; width:14px; height:14px; margin:5px 0; float:left; cursor:pointer;}         .closing .volume{ background:url(./audiojs/voice.png) no-repeat 0 0;}         .audiojs .error-message { float: left; display: none; margin: 0px 10px; width: 232px; height: 18px; line-height: 18px; overflow: hidden; white-space: nowrap; color: #ff0000;           text-overflow: ellipsis; -o-text-overflow: ellipsis; -icab-text-overflow: ellipsis; -khtml-text-overflow: ellipsis; -moz-text-overflow: ellipsis; -webkit-text-overflow: ellipsis; }         .audiojs .error-message a { color: #eee; text-decoration: none; padding-bottom: 1px; border-bottom: 1px solid #999; white-space: wrap; }                 .audiojs .play { background: url("$1") no-repeat 0px 0px; }         .audiojs .loading { background: url("$1") 0 -18px no-repeat; }         .audiojs .error { background: url("$1") 0 -36px no-repeat; }         .audiojs .pause { background: url("$1") no-repeat top center; }                 .playing .play, .playing .loading, .playing .error { display: none; }         .playing .pause { display: block; }                 .loading .play, .loading .pause, .loading .error { display: none; }         .loading .loading { display: block; }                 .error .time, .error .play, .error .pause, .error .scrubber, .error .loading, .error .playname, .error .volume { display: none; }         .error .error { display: block; }         .error .play-pause p { cursor: auto; }         .error .error-message { display: block; }',
            trackEnded: function () {
            },
            flashError: function () {
