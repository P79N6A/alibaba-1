function upload1() {
	...
	uploader1.on( 'fileQueued', function( file ) {
		...
		$("#personForm .user-uplrem").on("touchstart", function() {
			...
			uploader1.removeFile( $(this).parent('li').attr("id"), true );
...
function upload2() {
	...
	uploader2.on( 'fileQueued', function( file ) {
		...
		$("#teamForm .user-uplrem").on("touchstart", function() {
			$(this).parent('li').remove();
			uploader2.removeFile( $(this).parent('li').attr("id"), true );
			imgButton('teamForm');
		})
	});
...
function upload3() {
	...
	uploader3.on( 'fileQueued', function( file ) {
		...
		$("#companyForm .user-uplrem").on("touchstart", function() {
			$(this).parent('li').remove();
			uploader3.removeFile( $(this).parent('li').attr("id"), true );
...
function upload4() {
	...
	uploader4.on( 'fileQueued', function( file ) {
		...
		$(".tuser-uplrem").on("touchstart", function() {
			$(this).parent('li').remove();
			uploader4.removeFile( $(this).parent('li').attr("id"), true );
