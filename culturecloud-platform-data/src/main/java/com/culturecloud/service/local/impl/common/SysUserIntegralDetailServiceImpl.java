...
public class SysUserIntegralDetailServiceImpl implements SysUserIntegralDetailService {
	...
	@Override
	public int weekOpenAddIntegral(SysUserIntegralReqVO vo) {
		...
		SysUserIntegral SysUserIntegral=sysUserIntegralService.getUserIntegralByUserId(vo.getUserId());
		...
		data.put("integralFrom", vo.getLastWeedEndDate());
		...
		if(result>0)
		{
			...
			SysUserIntegralDetail.setIntegralFrom(vo.getLastWeedEndDate());
